      ...
      savedProblems = await Promise.all(
        generatedProblems.map(async (genProb) => {
          const input: CreateAbstractProblemInput = {
            ...
            unit,
            subsection,
            sequence_order: genProb.sequence_order,
            pedagogy_notes: genProb.pedagogy_notes,
            prerequisite_sequence: genProb.prerequisite_sequence,
            generation_rules: genProb.generation_rules,
            difficulty,
