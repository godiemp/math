...
## SVG Triangle Construction Guide

When creating geometric diagrams in SVG for mini-lessons, follow these patterns:

### Right Triangles

```tsx
{/* Right triangle with vertex at top-left */}
<svg viewBox="0 0 400 200" className="w-full max-w-md mx-auto">
  ...
  <text x="45" y="115" className="fill-blue-600 text-xs font-bold">height</text>

  {/* Base label - ALWAYS position BELOW the base */}
  <text x="140" y="195" textAnchor="middle" className="fill-gray-600 text-xs">base</text>
</svg>
```
...
### Dimension Lines Pattern

Always use dimension lines (tick marks at ends) for measurements:
...
<g>
  ...
  <text x="45" y="115" className="fill-blue-600 text-xs font-bold">1.6m</text>
</g>
```
