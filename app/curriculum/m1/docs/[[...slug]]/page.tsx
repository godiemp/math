  ...
  return (
    <ProtectedRoute>
      <div className="min-h-screen bg-[#F7F7F7] dark:bg-[#000000]">
        {/* Navbar */}
        <nav className="sticky top-0 z-30 h-14 backdrop-blur-[20px] bg-white/80 dark:bg-[#121212]/80 border-b border-black/[0.12] dark:border-white/[0.16]">
        ...
        <div className="flex">
          {/* Sidebar Navigation */}
          <aside className="hidden lg:block w-64 bg-white dark:bg-[#121212] border-r border-black/[0.12] dark:border-white/[0.16] h-[calc(100vh-3.5rem)] sticky top-14 overflow-y-auto">
            <div className="p-6">
              <Link
