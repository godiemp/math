...
type FigureType = 'triangle' | 'circle' | 'figure3d';
...
function FigureDebugContent() {
  ...
  const [show3dHiddenEdges, setShow3dHiddenEdges] = useState(true);
  ...
  const generateFigure3DCode = useCallback(() => {
    ...
    // Visual options
    if (!show3dHiddenEdges) {
      propsLines.push(`edges={{ hiddenEdgeStyle: 'none' }}`);
    }
    if (highlight3dBase) {
    ...
    return `<Figure3D\n  ${propsLines.join('\n  ')}\n/>`;
  }, [currentSolidDimensions, projectionType, figure3dAzimuth, figure3dElevation, figure3dInteractive, show3dHiddenEdges, highlight3dBase, show3dHeightLine, show3dDimensionLabels, show3dGrid]);
  ...
  }, [figureType, generateTriangleCode, generateCircleCode, generateFigure3DCode]);
              ...
              <div className="flex justify-center bg-white dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                {figureType === 'triangle' ? (
                  ...
                  <Figure3D
                    ...
                    showGrid={show3dGrid}
                    edges={{
                      hiddenEdgeStyle: show3dHiddenEdges ? 'dashed' : 'none',
                    }}
                    faceConfig={{
