...
import {
  ...
  Step5Practice,
  Step6Verify,
} from '@/components/lessons/m1/comparar-poblaciones';

const LESSON_SLUG = 'comparar-poblaciones';

export default function CompararPoblacionesPage() {
    ...
    >
      {({ currentStep, completeStep }) => {
        const steps = [
          ...
          <Step2ExploreScatter key="2" onComplete={completeStep} isActive={currentStep === 1} />,
