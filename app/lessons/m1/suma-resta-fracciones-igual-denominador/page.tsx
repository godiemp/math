...
import {
  Step1Hook,
  Step2ExploreAddition,
  Step3Explain,
  Step4Practice,
  Step5ExploreSubtraction,
  Step6Verify,
} from '@/components/lessons/m1/suma-resta-fracciones-igual-denominador';

const LESSON_SLUG = 'suma-resta-fracciones-igual-denominador';

export default function SumaRestaFraccionesIgualDenominadorLesson() {
