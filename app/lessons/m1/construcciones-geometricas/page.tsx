...
import {
  ...
  Step5Practice,
  Step6Verify,
} from '@/components/lessons/m1/construcciones-geometricas';

const LESSON_SLUG = 'construcciones-geometricas';

export default function ConstruccionesGeometricasPage() {
