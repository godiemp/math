...
import {
  ...
  Step5Practice,
  Step6Verify,
} from '@/components/lessons/m1/angulos-interiores-poligonos';

const LESSON_SLUG = 'angulos-interiores-poligonos';

export default function AngulosInterioresPoligonosPage() {
