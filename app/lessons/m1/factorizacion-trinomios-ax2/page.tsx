...
import {
  ...
  Step5Practice,
  Step6Verify,
} from '@/components/lessons/m1/factorizacion-trinomios-ax2';

const LESSON_SLUG = 'factorizacion-trinomios-ax2';

export default function FactorizacionTrinomiosAx2Lesson() {
