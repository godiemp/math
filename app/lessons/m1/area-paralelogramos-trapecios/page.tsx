...
import {
  ...
  Step4Practice,
  Step5Verify,
} from '@/components/lessons/m1/area-paralelogramos-trapecios';

const LESSON_SLUG = 'area-paralelogramos-trapecios';

export default function AreaParalelogramosTrapeciosLesson() {
