...
import {
  ...
  Step5Practice,
  Step6Verify,
} from '@/components/lessons/m1/proporcion-directa-inversa';

const LESSON_SLUG = 'proporcion-directa-inversa';

export default function ProporcionDirectaInversaLesson() {
