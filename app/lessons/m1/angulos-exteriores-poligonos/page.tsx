...
import {
  ...
  Step4Practice,
  Step5Verify,
} from '@/components/lessons/m1/angulos-exteriores-poligonos';

const LESSON_SLUG = 'angulos-exteriores-poligonos';

export default function AngulosExterioresPoligonosLesson() {
    ...
    <LessonShell lesson={lesson} onComplete={handleComplete} onExit={handleExit}>
      {({ currentStep, completeStep }) => {
        const stepComponents = [
          ...
          <Step4Practice key="step4" onComplete={completeStep} isActive={currentStep === 3} />,
          <Step5Verify key="step5" onComplete={completeStep} isActive={currentStep === 4} />,
        ];
