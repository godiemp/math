...
import {
  ...
  Step5Practice,
  Step6Verify,
} from '@/components/lessons/m1/potencias-exponente-positivo';

const LESSON_SLUG = 'potencias-exponente-positivo';

export default function PotenciasExponentePositivoLesson() {
