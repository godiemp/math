...
import {
  Step1Hook,
  Step2ExploreMultiples,
  Step3Explain,
  Step4Practice,
  Step5ExploreSynchronization,
  Step6Verify,
} from '@/components/lessons/m1/minimo-comun-multiplo';

const LESSON_SLUG = 'minimo-comun-multiplo';

export default function MinimoComunMultiploLesson() {
