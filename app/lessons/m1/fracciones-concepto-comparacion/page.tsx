...
import {
  ...
  Step5NumberLine,
  Step6Verify,
} from '@/components/lessons/m1/fracciones-concepto-comparacion';

const LESSON_SLUG = 'fracciones-concepto-comparacion';

export default function FraccionesConceptoComparacionLesson() {
