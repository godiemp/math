...
import {
  ...
  Step5Division,
  Step6Verify,
} from '@/components/lessons/m1/multiplicacion-division-fracciones';

const LESSON_SLUG = 'multiplicacion-division-fracciones';

export default function MultiplicacionDivisionFraccionesLesson() {
