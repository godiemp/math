...
Si egresaste de cuarto medio y quieres mejorar tu puntaje o rendir la PAES por primera vez, la **PAES de Invierno 2025** (Proceso de Admisión 2026) es tu oportunidad. Esta prueba anticipada te permite postular a las universidades con resultados en mano antes que el resto.

Aquí tienes toda la información oficial actualizada para que no te pierdas nada.

## Fechas clave PAES Invierno 2026

| Etapa | Fecha |
|-------|-------|
| Inscripción | 5 al 18 de marzo de 2025 |
| Rendición | **16, 17 y 18 de junio de 2025** |
| Resultados | 18 de julio de 2025 |
| Postulación a universidades | Enero 2026 |

**Importante:** La inscripción tiene un límite de 50.000 cupos. Si se llenan antes del 18 de marzo, la plataforma cierra anticipadamente. No esperes hasta el último día.

## ¿Quiénes pueden rendir la PAES de Invierno?

Esta prueba es **exclusivamente para egresados**. Puedes inscribirte si:

- Egresaste de enseñanza media en 2024 o años anteriores
- Tienes tu Licencia de Enseñanza Media o Certificado de egreso
- Eres chileno o extranjero con estudios validados en Chile

**Si estás en 4° medio en 2025, no puedes inscribirte.** Deberás esperar a la PAES Regular de diciembre.

## Costos de inscripción

| Cantidad de pruebas | Costo |
|---------------------|-------|
| 1 prueba | $16.650 |
| 2 pruebas | $30.475 |
| 3 o más pruebas | $44.300 |
...
**Nuevas sedes:** Colina, Talagante (Región Metropolitana), Talcahuano y Coronel (Región del Biobío).
...
| Prueba | Promedio | Cambio vs. año anterior |
|--------|----------|------------------------|
| Matemática M1 | 625 puntos | +22 puntos |
| Matemática M2 | 418 puntos | +7 puntos |
| Competencia Lectora | 596 puntos | -3 puntos |

El promedio de M1 subió significativamente, lo que sugiere que los estudiantes están llegando mejor preparados o que las preguntas se ajustaron. De cualquier forma, **625 puntos es solo el promedio**—para carreras competitivas necesitas estar muy por encima.

### La brecha sigue siendo real

- **61.3%** de estudiantes de colegios particulares pagados quedaron en el top 20% nacional
- **16.8%** de subvencionados
- **9.5%** de colegios públicos

Esto no significa que no puedas destacar viniendo de cualquier tipo de colegio. Significa que necesitas una preparación más intencional y estratégica si no tuviste acceso a los mismos recursos.
...
**Sí, si:**
- Quieres tener un puntaje asegurado antes de fin de año
- Necesitas mejorar tu puntaje anterior
- Prefieres postular con calma en enero, sabiendo tu resultado

**Considera la Regular si:**
- Estás en 4° medio (no tienes opción)
- Sientes que necesitas más tiempo de preparación
- Prefieres rendir cuando todos rinden
...
*¿Quieres identificar exactamente qué temas necesitas reforzar? SimplePAES tiene diagnósticos adaptativos que detectan tus lagunas y práctica enfocada en lo que realmente viene en la PAES.*
