...
Tienes 35 estudiantes. Cinco ya entendieron antes de que terminaras de explicar. Diez están siguiendo el ritmo. Otros diez necesitan que lo expliques de nuevo, más lento. Y diez más están perdidos desde hace dos unidades—o dos años.

La teoría dice que deberías "diferenciar": adaptar tu enseñanza a cada nivel. Preparar actividades distintas. Agrupar por habilidad. Dar retroalimentación personalizada.
...
En la práctica:
- Preparar tres versiones de cada actividad triplica tu tiempo de planificación
- Mientras atiendes a un grupo, los otros dos se pierden o se aburren
...
Todos trabajan el mismo problema base. La diferencia está en qué hacen después:

| Nivel | Instrucción |
|-------|-------------|
| Base | Resuelve los ejercicios 1-5 |
...
**Por qué funciona:**
- No requiere preparación extra—solo estructurar el tiempo distinto
...
**Ejemplo: Probabilidad en 3° medio**

| Estación | Actividad | Recurso |
|----------|-----------|---------|
| 1 | Ejercicios de cálculo de probabilidades | Guía impresa con respuestas al reverso |
| 2 | Problemas de contexto (probabilidad en situaciones reales) | Guía con pauta de verificación |
...
- Cuando las actividades de las estaciones son autoverificables

**Cuándo NO funciona:**
- Temas que requieren tu explicación continua
...
1. Identifica tus 8-10 estudiantes más fuertes en el tema actual
2. Emparéjalos con estudiantes que necesitan apoyo (no con los que más les cuesta—eso frustra a ambos)
3. El "tutor" tiene una pauta con las respuestas y los errores comunes
4. Tú atiendes a los 5-6 que más dificultades tienen, directamente

**Reglas para que funcione:**
- El tutor no da respuestas, hace preguntas: "¿Qué hiciste primero? ¿Qué pasa si...?"
- Rota los pares cada 2-3 semanas (evita dependencia)
...
|----------|----------------|
| Explicación del contenido | Práctica en plataforma adaptativa |
| Resolución guiada de ejemplos | Ejercicios de refuerzo para quienes lo necesitan |
| Atención a casos difíciles | Extensión para quienes van adelante |

**El problema clásico:** "Mis estudiantes no hacen las tareas."

**La solución:** Usa una plataforma que:
- Te muestre quién practicó y quién no
...
El error clásico es enfocarse en los que les cuesta y dejar que los avanzados "se las arreglen". Terminan aburridos, desenganchados, y eventualmente desmotivados. Las extensiones y desafíos no son opcionales—son necesarios.
...
2. **Tener material listo** para distintos niveles (extensiones, no currículos paralelos)
3. **Liberar tu tiempo** de los que pueden solos para dedicarlo a los que no pueden
4. **Usar herramientas** que escalen lo que tú no puedes hacer 35 veces

No vas a poder personalizar cada minuto de clase para cada estudiante. Pero sí puedes crear un sistema donde la práctica se diferencia, las extensiones existen, y tu atención va a donde más impacto tiene.

---

*Con SimplePAES, la práctica se diferencia automáticamente: cada estudiante recibe ejercicios a su nivel, con retroalimentación inmediata. Tú ves desde tu panel quién necesita intervención—sin corregir nada. [Conoce nuestros planes para colegios](https://simplepaes.cl/profesores).*
