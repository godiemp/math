...
const PROBLEMS: Problem[] = [
  {
    ...
    correctIndex: 0,
    hint: 'Con centro en el origen: P\' = k · P = 2 · (2, 3) = (4, 6). Cada coordenada se duplica.',
  },
  {
    id: 'p2',
    ...
    correctIndex: 1,
    hint: 'Con centro en el origen: P\' = k · P = 0.5 · (6, 4) = (3, 2). Cada coordenada se reduce a la mitad.',
  },
  {
    id: 'p3',
    ...
    correctIndex: 1,
    hint: 'Con centro en el origen: P\' = k · P = ⅓ · (3, 6) = (1, 2). Cada coordenada se divide entre 3.',
  },
  {
    id: 'p4',
    description: 'Centro C = (0, 0), Punto P = (4, -2), k = -1',
    expression: "P' = ?",
    options: ['(-4, 2)', '(4, -2)', '(-2, 1)', '(8, -4)'],
    correctIndex: 0,
    hint: 'Con centro en el origen: P\' = k · P = -1 · (4, -2) = (-4, 2). El signo negativo invierte las coordenadas.',
  },
  {
    id: 'p5',
    ...
    correctIndex: 2,
    hint: 'Con centro en el origen: P\' = k · P = 0.25 · (8, 6) = (2, 1.5). Cada coordenada se reduce a un cuarto.',
  },
  {
    id: 'p6',
    ...
    correctIndex: 1,
    hint: 'Aquí el centro NO es el origen. Paso 1: Vector (P - C) = (4,3) - (1,1) = (3,2). Paso 2: Escalar: -1 · (3,2) = (-3,-2). Paso 3: P\' = C + resultado = (1,1) + (-3,-2) = (-2,-1).',
  },
  {
    id: 'p7',
    ...
    correctIndex: 0,
    hint: 'Centro NO en origen. Vector (P - C) = (4,4) - (2,2) = (2,2). Escalar: 3 · (2,2) = (6,6). P\' = C + resultado = (2,2) + (6,6) = (8,8).',
  },
  {
    id: 'p8',
    ...
    correctIndex: 0,
    hint: 'Centro NO en origen. Vector (P - C) = (5,4) - (3,2) = (2,2). Escalar: -2 · (2,2) = (-4,-4). P\' = C + resultado = (3,2) + (-4,-4) = (-1,-2).',
  },
  {
    id: 'p9',
    ...
    correctIndex: 1,
    hint: '¡Caso especial! El punto P coincide con el centro C. Vector (P - C) = (0, 0). Cualquier k × (0, 0) = (0, 0). El centro siempre queda fijo: P\' = C = (2, 3).',
  },
  {
    id: 'p10',
    ...
    correctIndex: 0,
    hint: 'Centro NO en origen. Vector (P - C) = (5,4) - (1,0) = (4,4). Escalar: 1.5 · (4,4) = (6,6). P\' = C + resultado = (1,0) + (6,6) = (7,6).',
  },
];
