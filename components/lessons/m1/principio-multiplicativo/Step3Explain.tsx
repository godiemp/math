...
type TabId = 'basic' | 'multiple' | 'restrictions' | 'order' | 'tips';
...
const FORMULAS: FormulaTab[] = [
  ...
  },
  {
    ...
    description: 'Cuando hay más de dos decisiones que tomar, multiplicas TODAS las opciones',
    formula: 'Total = n₁ × n₂ × n₃ × ... × nₖ',
    example: {
      input: '3 entradas, 5 platos principales y 4 postres',
      steps: [
        'Paso 1: Identificar cada decisión independiente',
        'n₁ = 3 (opciones de entrada)',
        'n₂ = 5 (opciones de plato principal)',
        'n₃ = 4 (opciones de postre)',
        'Paso 2: Multiplicar TODAS las opciones',
        'Total = 3 × 5 × 4 = 15 × 4 = 60',
      ],
      result: '60 menús diferentes',
    },
    color: 'purple',
  },
  {
