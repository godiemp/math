    ...
    <div className="space-y-8 animate-fadeIn pb-32">
        ...
        <div className="space-y-6 animate-fadeIn">
          <div className={cn(
            ...
            <p className={cn(
              ...
              {passed
                ? 'Has dominado las formulas del circulo'
          ...
          {passed && (
            <div className="bg-teal-50 dark:bg-teal-900/30 rounded-xl p-4 border border-teal-200 dark:border-teal-700">
              <h4 className="font-semibold text-teal-800 dark:text-teal-200 mb-2">
                Formulas que aprendiste:
              </h4>
              <ul className="text-sm text-teal-700 dark:text-teal-300 space-y-1">
                <li>- <strong>Pi (π):</strong> ≈ 3.14</li>
                <li>- <strong>Circunferencia:</strong> C = 2πr = πd</li>
      ...
      {showCelebration && (
        <Celebration
          ...
          message="Has aprendido a calcular la circunferencia y el area de circulos. ¡Excelente trabajo!"
