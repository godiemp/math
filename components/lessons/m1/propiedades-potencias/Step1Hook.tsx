        ...
        <div className="space-y-6 animate-fadeIn">
          ...
          <div className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/30 dark:to-orange-900/30 rounded-2xl p-6 border border-amber-200 dark:border-amber-800">
            <p className="text-gray-700 dark:text-gray-300 text-lg mb-6">
              ...
              En la <strong className="text-blue-600">primera fase</strong>, una bacteria se divide <strong>2³ = 8 veces</strong>.
              En la <strong className="text-purple-600">segunda fase</strong>, cada una se divide <strong>2⁴ = 16 veces más</strong>.
            </p>
      ...
      {phase === 'result' && (
        <div className="space-y-6 animate-fadeIn">
          ...
          <div className="flex justify-center">
            ...
            >
              <span>Descubrir todas las propiedades</span>
              <ArrowRight size={20} />
            </button>
          </div>
        </div>
