        ...
        <div className="space-y-6 animate-fadeIn">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
            ...
            <div className="space-y-3 mb-6">
              {example.steps.slice(0, currentStep + 1).map((step, i) => (
                <div
                  key={i}
                  className={cn(
            ...
            {!showSolution && (
              <div className="text-center mb-4">
                <button
                  ...
                  className="flex items-center gap-2 mx-auto text-sm text-blue-600 hover:text-blue-700 dark:text-blue-400"
                >
                  <Lightbulb size={16} />
            ...
            {!showSolution ? (
              <div className="flex justify-center">
                ...
                >
                  {currentStep < example.steps.length - 1 ? 'Siguiente paso' : 'Ver solución'}
                </button>
              </div>
            ) : (
              <div className="space-y-4 animate-fadeIn">
                <div className="bg-green-50 dark:bg-green-900/30 rounded-xl p-6 border border-green-200 dark:border-green-700">
                  <div className="text-center space-y-3">
                    ...
                    <p className="font-mono text-3xl font-bold text-green-600">{example.solution}</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Verificación: {example.equation.replace('x', `(${example.solution.split('= ')[1]})`)}
                    </p>
                  </div>
                </div>
