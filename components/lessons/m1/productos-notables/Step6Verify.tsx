...
const QUESTIONS: Question[] = [
  {
    ...
    correctAnswer: 2,
    explanation: 'El cuadrado de un binomio tiene TRES términos: el primero al cuadrado (x²), el doble producto (2·x·4=8x), y el segundo al cuadrado (16). La fórmula es (a+b)² = a² + 2ab + b².',
  },
  {
    id: 'q2',
    ...
    correctAnswer: 1,
    explanation: 'Es suma por diferencia porque tiene la forma (A+B)(A-B) donde A=3a y B=7. El resultado será A² - B² = 9a² - 49. Los términos medios se cancelan.',
  },
  {
    id: 'q3',
    ...
    correctAnswer: 1,
    explanation: 'Usando (x+a)(x+b) = x² + (a+b)x + ab con a=-5 y b=3: La suma es -5+3=-2, el producto es (-5)(3)=-15. Resultado: x² - 2x - 15',
  },
  {
    id: 'q4',
    question: 'Un estudiante escribió: (2x - 3)² = 4x² - 9. ¿Qué error cometió?',
    options: [
    ...
    correctAnswer: 0,
    explanation: '(2x - 3)² es un cuadrado de binomio, NO suma por diferencia. La respuesta correcta es 4x² - 12x + 9. El estudiante aplicó la fórmula de (A+B)(A-B) = A² - B² en lugar de (A-B)² = A² - 2AB + B².',
  },
];
    ...
    <div className="space-y-8 animate-fadeIn pb-32">
        ...
        <div className="space-y-6 animate-fadeIn">
          ...
          {passed && (
            <div className="bg-purple-50 dark:bg-purple-900/30 rounded-xl p-6 border border-purple-200 dark:border-purple-700">
              <h4 className="font-bold text-purple-800 dark:text-purple-200 mb-3">Recuerda los tres productos notables:</h4>
      ...
      {showCelebration && (
        <Celebration
          ...
          message="Has dominado los tres productos notables: cuadrado de binomio, suma por diferencia, y binomios con término común. ¡Ahora puedes simplificar expresiones algebraicas mucho más rápido!"
