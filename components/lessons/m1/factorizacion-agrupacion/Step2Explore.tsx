...
const EXAMPLES: GroupingExample[] = [
  ...
  },
  {
    ...
    commonFactor: '(x - 5)',
    result: '(x - 5)(x + 3)',
    hint: 'Del primer grupo sacamos x, del segundo sacamos 3. Ambos paréntesis quedan (x - 5)',
  },
  {
    id: 'negative',
    ...
    commonFactor: '(x + 3)',
    result: '(x + 3)(x - 2)',
    hint: '¡Cuidado! Del segundo grupo debes sacar -2 (no +2) para que el paréntesis coincida',
  },
];
