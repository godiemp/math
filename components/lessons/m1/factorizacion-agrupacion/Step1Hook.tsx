...
const OPTIONS = ['(x + 2)(y + 3)', '(x + 3)(y + 2)', '(xy + 6)(2 + 3)', 'xy + 2x + 3y + 6'];
  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">El Terreno del Arquitecto</h2>
        ...
        <div className="space-y-6 animate-fadeIn">
          <ScenarioCard variant="warm">
            <p className="text-gray-700 dark:text-gray-300 text-lg mb-6">
              Un arquitecto necesita <strong className="text-blue-600">cercar un terreno rectangular</strong>. Solo
              conoce el <strong className="text-purple-600">área total</strong>, que está dividida en 4 secciones:
            </p>
            ...
            <div className="flex flex-col items-center gap-6 mb-6">
                ...
                <div className="flex justify-center">
                  <svg viewBox="0 0 280 220" className="w-full max-w-xs">
                    ...
                    <text
                      ...
                      y="152"
                      textAnchor="middle"
                      className="text-lg font-bold fill-pink-700"
                      style={{ fontSize: '18px', fontFamily: 'monospace' }}
                    >
                      6
                    </text>
                    ...
                    <text x="20" y="115" textAnchor="middle" className="fill-gray-500" style={{ fontSize: '24px' }}>
                      ?
                    </text>
                    <text x="140" y="25" textAnchor="middle" className="fill-gray-500" style={{ fontSize: '24px' }}>
                      ?
                    </text>
                  </svg>
                </div>
              ...
              <div className="bg-purple-100 dark:bg-purple-900/50 rounded-xl p-4 max-w-md">
                <p className="text-gray-700 dark:text-gray-300 text-center mb-2">El área total del terreno es:</p>
              ...
              <div className="bg-amber-100 dark:bg-amber-900/50 rounded-xl p-4 max-w-md">
                <p className="text-amber-800 dark:text-amber-200 text-center">
                  El arquitecto necesita saber el <strong>largo</strong> y el <strong>ancho</strong> del terreno para
                  comprar la cantidad exacta de cerca. ¿Cuáles podrían ser las dimensiones?
                </p>
              </div>
            </div>
          </ScenarioCard>
        ...
        <div className="space-y-6 animate-fadeIn">
          ...
          {showFeedback && (
            <FeedbackPanel
              ...
              explanation={
                isCorrect
                  ? '¡Exacto! Veamos cómo encontrar las dimensiones...'
                  : '¡Casi! Veamos cómo encontrar las dimensiones...'
              }
            />
          )}
        </div>
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 rounded-2xl p-6 border border-green-200 dark:border-green-800">
            ...
            <div className="flex justify-center mb-6">
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-inner">
                <svg viewBox="0 0 320 220" className="w-full max-w-sm">
                  ...
                  <line x1="60" y1="25" x2="260" y2="25" stroke="#9333ea" strokeWidth="2" />
                  ...
                  <text
                    ...
                    y="155"
                    textAnchor="middle"
                    className="fill-pink-700 font-bold"
                    style={{ fontSize: '18px', fontFamily: 'monospace' }}
                  >
                    6
                  </text>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-4 mb-4">
              <div className="text-center space-y-3">
                ...
                <p className="font-mono text-xl text-green-600 font-bold">Largo: (x + 3) · Ancho: (y + 2)</p>
              </div>
            </div>
            ...
            <div className="bg-green-100 dark:bg-green-900/50 rounded-lg p-3 text-center">
              ...
              <p className="font-mono text-green-700 dark:text-green-300">(x + 3)(y + 2) = xy + 2x + 3y + 6 ✓</p>
            </div>
          </div>

          <InsightCard title="¡Esto es Factorización por Agrupación!" variant="purple">
            <div className="space-y-4">
              <div className="bg-white dark:bg-gray-800 p-4 rounded-xl text-center">
                <p className="text-sm mb-2">
                  Encontrar las dimensiones de un área es lo mismo que <strong>factorizar</strong>:
                </p>
