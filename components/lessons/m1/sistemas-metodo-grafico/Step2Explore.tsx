...
const EXAMPLES: ExploreExample[] = [
  {
    id: 1,
    title: 'Ejemplo 1: Una solución',
    equation1: 'x + y = 4',
    equation2: 'x - y = 2',
    line1Points: [{ x: 0, y: 4 }, { x: 4, y: 0 }],
    line2Points: [{ x: 0, y: -2 }, { x: 4, y: 2 }],
    solution: { x: 3, y: 1 },
    explanation: 'Las rectas se cruzan en un punto: la solución única (3, 1)',
  },
  {
    id: 2,
    title: 'Ejemplo 2: Verificación',
    equation1: '2x + y = 7',
    equation2: 'x - y = 2',
    line1Points: [{ x: 0, y: 7 }, { x: 3.5, y: 0 }],
    line2Points: [{ x: 0, y: -2 }, { x: 4, y: 2 }],
    solution: { x: 3, y: 1 },
    explanation: 'También x = 3, y = 1: Verifica: 2(3) + 1 = 7 ✓ y 3 - 1 = 2 ✓',
  },
  {
    id: 3,
    title: 'Ejemplo 3: Otro sistema',
    equation1: 'x + y = 5',
    equation2: '2x + y = 8',
    line1Points: [{ x: 0, y: 5 }, { x: 5, y: 0 }],
    line2Points: [{ x: 0, y: 8 }, { x: 4, y: 0 }],
    solution: { x: 3, y: 2 },
    explanation: 'Solución: (3, 2). Verifica: 3 + 2 = 5 ✓ y 2(3) + 2 = 8 ✓',
  },
];
