...
const QUESTIONS: Question[] = [
  {
    ...
    correctAnswer: 1,
    explanation: 'Distribuir significa que el factor de afuera multiplica a cada uno de los términos dentro del paréntesis, como repartir algo a todos.',
  },
  {
    id: 'q2',
    ...
    correctAnswer: 2,
    explanation: 'El error está en C: 5 debe multiplicar AMBOS términos. 5 × 2x = 10x y 5 × 1 = 5, así que el resultado correcto es 10x + 5.',
  },
  {
    id: 'q3',
    ...
    correctAnswer: 0,
    explanation: '2(x + 4) + 3(x - 1) = 2x + 8 + 3x - 3 = 5x + 5. Primero distribuimos cada factor, luego combinamos términos semejantes.',
  },
  {
    id: 'q4',
    question: '¿Por qué es importante conocer términos semejantes ANTES de aprender la propiedad distributiva?',
    options: [
      'No tiene relación',
    ...
    correctAnswer: 1,
    explanation: 'La propiedad distributiva crea nuevos términos que a menudo deben combinarse. Por ejemplo, 2(x + 1) + 3x = 2x + 2 + 3x = 5x + 2. Usamos distribución Y combinación de términos semejantes.',
  },
];
    ...
    <div className="space-y-8 animate-fadeIn pb-32">
          ...
          {passed && (
            <div className="bg-purple-50 dark:bg-purple-900/30 rounded-xl p-6 border border-purple-200 dark:border-purple-700">
              ...
              <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                <li>• <strong>a(b + c) = ab + ac</strong> - El factor multiplica a cada término</li>
                <li>• Cuidado con los signos: (-) × (-) = (+)</li>
                <li>• Después de distribuir, combina términos semejantes</li>
                <li>• El signo negativo solo (-) equivale a multiplicar por -1</li>
              </ul>
            </div>
          )}
      ...
      {showCelebration && (
        <Celebration
          ...
          message="Has demostrado que entiendes la propiedad distributiva. Ahora puedes expandir expresiones y combinarlas con términos semejantes. ¡Excelente trabajo!"
