...
const PROBLEMS: Problem[] = [
  {
    ...
    correctIndex: 0,
    hint: '5 × x = 5x, y 5 × 3 = 15',
  },
  {
    expression: '2(y - 4)',
    options: ['2y - 8', '2y - 4', '2y + 8', '-2y'],
    correctIndex: 0,
    hint: '2 × y = 2y, y 2 × (-4) = -8',
  },
  {
    expression: '4(3 + x)',
    options: ['4x + 12', '12 + x', '7x', '4x + 3'],
    correctIndex: 0,
    hint: '4 × 3 = 12, y 4 × x = 4x. Resultado: 12 + 4x = 4x + 12',
  },
  {
    expression: '-3(x + 2)',
  ...
  {
    expression: '-2(y - 5)',
    options: ['-2y + 10', '-2y - 10', '2y - 10', '-2y - 5'],
    correctIndex: 0,
    hint: '(-2) × y = -2y, y (-2) × (-5) = +10',
  },
  {
    expression: '6(2x + 1)',
    options: ['12x + 6', '12x + 1', '8x + 6', '6x + 6'],
    correctIndex: 0,
    hint: '6 × 2x = 12x, y 6 × 1 = 6',
  },
  {
    expression: '-(3x - 7)',
    options: ['-3x + 7', '-3x - 7', '3x - 7', '3x + 7'],
    correctIndex: 0,
    hint: 'El signo negativo es como -1. (-1) × 3x = -3x, y (-1) × (-7) = +7',
  },
  {
    expression: '3(x + 2) + 2x',
    options: ['5x + 6', '3x + 6', '5x + 2', '6x + 6'],
    correctIndex: 0,
    hint: 'Primero distribuye: 3x + 6. Luego suma: 3x + 6 + 2x = 5x + 6',
  },
  {
    expression: '2(y - 1) - 3y',
    options: ['-y - 2', '5y - 2', '-y + 2', 'y - 2'],
    correctIndex: 0,
    hint: 'Distribuye: 2y - 2. Luego resta: 2y - 2 - 3y = -y - 2',
  },
  {
    expression: '4(2x + 3) - 5(x - 1)',
    options: ['3x + 17', '3x + 7', '13x + 17', '3x + 12'],
    correctIndex: 0,
    hint: '4(2x + 3) = 8x + 12 y -5(x - 1) = -5x + 5. Luego: 8x + 12 - 5x + 5 = 3x + 17',
  },
];
      ...
      {!isComplete ? (
        ...
        <div className="space-y-6 animate-fadeIn">
          ...
          >
            ...
            >
              {passed
                ? 'Has demostrado que dominas la propiedad distributiva'
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4">
            ...
            <div className="grid grid-cols-5 gap-2">
              {PROBLEMS.map((p, i) => (
                ...
                >
                  <div className="font-mono font-bold truncate">{p.expression}</div>
