...
const QUESTIONS: Question[] = [
  {
    ...
    correctAnswer: 1,
    explanation: 'Los números mayores que 4 son: 5 y 6. Son 2 casos favorables de 6 posibles. P = 2/6 = 1/3',
  },
  {
    id: 'q2',
    question: 'Si la probabilidad de lluvia es 0.4, ¿cuál es la probabilidad de que NO llueva?',
    type: 'multiple-choice',
    options: ['0.4', '0.5', '0.6', '1.0'],
    correctAnswer: 2,
    explanation: 'Usando el complemento: P(NO lluvia) = 1 - P(lluvia) = 1 - 0.4 = 0.6',
  },
  {
    id: 'q3',
    question: 'Una bolsa tiene 3 bolas rojas, 2 azules y 5 verdes. ¿Cuál es la probabilidad de sacar una bola azul?',
    type: 'multiple-choice',
    options: ['2/5', '2/10', '2/3', '5/10'],
    correctAnswer: 1,
    explanation: 'Hay 2 bolas azules y 10 bolas en total (3+2+5=10). P(azul) = 2/10 = 1/5',
  },
  {
    id: 'q4',
    question: 'En un mazo de 52 cartas, ¿cuál es la probabilidad de sacar un corazón?',
    type: 'multiple-choice',
    options: ['1/52', '4/52', '13/52', '26/52'],
    correctAnswer: 2,
    explanation: 'Hay 13 cartas de corazón en un mazo de 52 cartas. P(corazón) = 13/52 = 1/4',
  },
  {
    id: 'q5',
    ...
    correctAnswer: 3,
    explanation: 'La probabilidad siempre está entre 0 y 1. P = 1.5 es imposible porque es mayor que 1.',
  },
];
    ...
    <div className="space-y-8 animate-fadeIn pb-32">
        ...
        <div className="space-y-6 animate-fadeIn">
          <div className={cn(
            ...
            <p className={cn(
              ...
              {passed
                ? 'Has dominado los conceptos básicos de probabilidad'
          ...
          {passed && (
            <div className="bg-purple-50 dark:bg-purple-900/30 rounded-xl p-4 border border-purple-200 dark:border-purple-700">
              ...
              <ul className="text-sm text-purple-700 dark:text-purple-300 space-y-1">
                <li>• <strong>P(A)</strong> = Casos favorables / Casos posibles</li>
                <li>• <strong>P(NO A)</strong> = 1 - P(A)</li>
                <li>• La probabilidad siempre está entre <strong>0 y 1</strong></li>
              </ul>
            </div>
          )}
      ...
      {showCelebration && (
        <Celebration
          ...
          message="Has aprendido a calcular probabilidades de eventos simples. ¡Excelente trabajo!"
