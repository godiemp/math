...
export default function Step1Hook({ onComplete, isActive }: LessonStepProps) {
  ...
  const correctAnswer = 2; // "(25 + 23)(25 - 23) = 48 × 2 = 96"
    ...
    <div className="space-y-8 animate-fadeIn">
            ...
            {options.map((option, index) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-800 dark:text-gray-200 font-mono text-sm">{option}</span>
                </div>
              </button>
            ))}
          </div>
          ...
          {showFeedback && (
            ...
            >
              <p className={cn('font-semibold', isCorrect ? 'text-green-700 dark:text-green-300' : 'text-amber-700 dark:text-amber-300')}>
                {isCorrect ? '¡Exacto!' : '¡Casi!'} Veamos el truco de Sofía...
              </p>
            </div>
          )}
        </div>
      ...
      {phase === 'result' && (
        <div className="space-y-6 animate-fadeIn">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-inner">
                <div className="text-center space-y-4">
                  ...
                  <p className="font-mono text-sm text-gray-600 dark:text-gray-400">
                    = (<span className="text-blue-600">25</span> + <span className="text-purple-600">23</span>)(<span className="text-blue-600">25</span> - <span className="text-purple-600">23</span>)
                  </p>
                  <p className="font-mono text-sm text-gray-600 dark:text-gray-400">
          ...
          {/* Bridge to difference of squares concept */}
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h4 className="font-bold text-purple-800 dark:text-purple-200 mb-3 flex items-center gap-2">
                  ...
                  ¡Esto es la Diferencia de Cuadrados!
                </h4>
                <div className="space-y-4 text-gray-700 dark:text-gray-300">
                  <div className="bg-white dark:bg-gray-800 p-4 rounded-xl text-center">
                    <p className="text-sm mb-2">La diferencia de dos cuadrados siempre se puede factorizar como:</p>
                    <p className="font-mono text-lg">
                      <span className="text-blue-600 font-bold">a²</span> - <span className="text-purple-600 font-bold">b²</span> = (<span className="text-blue-600 font-bold">a</span> + <span className="text-purple-600 font-bold">b</span>)(<span className="text-blue-600 font-bold">a</span> - <span className="text-purple-600 font-bold">b</span>)
                    </p>
                  </div>
                  <div className="bg-amber-50 dark:bg-amber-900/30 p-3 rounded-lg border border-amber-200 dark:border-amber-700">
                    <p className="text-amber-800 dark:text-amber-200 text-sm text-center">
                      Esto funciona tanto para <strong>números</strong> como para <strong>expresiones algebraicas</strong>
                    </p>
                  </div>
                </div>
              </div>
