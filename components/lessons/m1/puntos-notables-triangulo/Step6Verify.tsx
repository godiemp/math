...
const QUESTIONS: CheckpointQuestion[] = [
  {
    ...
    options: ['Alturas', 'Transversales de gravedad', 'Simetrales', 'Bisectrices'],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 'q3',
    question: '¿Qué punto notable se forma con la intersección de las transversales de gravedad?',
    options: ['Circuncentro', 'Incentro', 'Baricentro', 'Ortocentro'],
    correctAnswer: 2,
    explanation:
      'Las transversales de gravedad van desde cada vértice al punto medio del lado opuesto. Su intersección es el baricentro (centro de gravedad).',
  },
  {
    id: 'q4',
