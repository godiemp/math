...
interface Question {
  id: string;
  question: string;
  type: 'computation' | 'word-problem' | 'conceptual';
  options: string[];
...
const QUESTIONS: Question[] = [
  {
    ...
    options: ['-11', '-5', '5', '11'],
    correctAnswer: 1,
    explanation: 'Signos diferentes: resta los valores absolutos (8-3=5) y usa el signo del mayor. Como |-8| > |3|, el resultado es negativo: -5',
  },
  {
    id: 'q2',
    question: 'Calcula: 4 - (-6)',
    type: 'computation',
    options: ['-10', '-2', '2', '10'],
    correctAnswer: 3,
    explanation: 'Restar un negativo es sumar un positivo: 4 - (-6) = 4 + 6 = 10',
  },
  {
    id: 'q3',
    question: 'Un submarino está a -15 metros de profundidad. Sube 8 metros y luego baja 3 metros. ¿A qué profundidad está ahora?',
    type: 'word-problem',
    options: ['-20 metros', '-10 metros', '-6 metros', '10 metros'],
    correctAnswer: 1,
    explanation: 'Empezamos en -15. Subir 8m es sumar +8: -15 + 8 = -7. Bajar 3m es sumar -3: -7 + (-3) = -10 metros',
  },
  {
    id: 'q4',
    question: '¿Por qué restar un número negativo da un resultado mayor?',
    type: 'conceptual',
    options: [
      'Porque los signos se cancelan siempre',
      'Porque restar un negativo es como sumar un positivo',
      'Porque el resultado siempre es positivo',
      'Porque los números negativos no existen',
    ],
    correctAnswer: 1,
    explanation: 'Restar un negativo equivale a sumar el opuesto (positivo). Por ejemplo: 5 - (-3) = 5 + 3. Por eso el resultado es mayor que el número original.',
  },
];
...
export default function Step6Verify({ onComplete, isActive }: LessonStepProps) {
  ...
  const getTypeBadge = (type: Question['type']) => {
    switch (type) {
      case 'computation':
        return { bg: 'bg-blue-100 dark:bg-blue-900/30', text: 'text-blue-700 dark:text-blue-300', label: 'Cálculo' };
      case 'word-problem':
        return { bg: 'bg-green-100 dark:bg-green-900/30', text: 'text-green-700 dark:text-green-300', label: 'Problema' };
      case 'conceptual':
        return { bg: 'bg-purple-100 dark:bg-purple-900/30', text: 'text-purple-700 dark:text-purple-300', label: 'Concepto' };
    }
  };
    ...
    <div className="space-y-8 animate-fadeIn pb-20">
      ...
      {showCelebration && (
        <Celebration
          ...
          message="Has demostrado que sabes sumar y restar números enteros. ¡Excelente trabajo!"
