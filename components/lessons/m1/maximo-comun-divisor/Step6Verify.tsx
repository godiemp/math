...
const QUESTIONS: VerifyQuestion[] = [
  {
    ...
    options: ['4', '6', '8', '12'],
    correctAnswer: 2,
    explanation: 'Divisores de 16: 1, 2, 4, 8, 16. Divisores de 24: 1, 2, 3, 4, 6, 8, 12, 24. El mayor común es 8.',
  },
  {
    id: 'q2',
    question: 'Para simplificar 24/36, dividimos numerador y denominador por:',
    type: 'multiple-choice',
    options: ['6', '8', '12', '4'],
    correctAnswer: 2,
    explanation: 'M.C.D.(24, 36) = 12. Dividiendo: 24÷12 = 2, 36÷12 = 3. Resultado: 2/3.',
  },
  {
    id: 'q3',
    ...
    correctAnswer: 2,
    explanation: 'M.C.D.(7, 11) = 1, así que 7/11 no se puede simplificar más. Las otras tienen divisores comunes mayores a 1.',
  },
  {
    id: 'q4',
    question: 'María quiere dividir 36 galletas y 48 dulces en bolsas idénticas sin que sobre nada. ¿Cuál es el máximo número de bolsas?',
    type: 'multiple-choice',
    options: ['6 bolsas', '8 bolsas', '12 bolsas', '18 bolsas'],
    correctAnswer: 2,
    explanation: 'M.C.D.(36, 48) = 12. Puede hacer 12 bolsas con 3 galletas y 4 dulces cada una.',
  },
  {
    id: 'q5',
    ...
    options: ['5', '7', '15', '1'],
    correctAnswer: 0,
    explanation: '15 = 3×5, 25 = 5×5, 35 = 5×7. El único factor común es 5, así que M.C.D.(15, 25, 35) = 5.',
  },
];
    ...
    return (
      <div className="space-y-6 animate-fadeIn">
        ...
        >
          ...
          >
            {percentage === 100 &&
              '¡Perfecto! Dominaste el M.C.D.'}
            {percentage >= 75 &&
              percentage < 100 &&
              '¡Muy bien! Tienes un sólido entendimiento.'}
            {percentage >= 50 &&
              percentage < 75 &&
              'Buen progreso. Repasa el método de los factores.'}
        ...
        <div className="bg-blue-50 dark:bg-blue-900/30 rounded-xl p-5 border border-blue-200 dark:border-blue-700">
          ...
          <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">
            <li className="flex items-start gap-2">
              ...
              <span><strong>M.C.D.</strong> = Máximo Común Divisor</span>
            </li>
            <li className="flex items-start gap-2">
              <Check className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
              <span>Es el <strong>mayor número</strong> que divide exactamente a todos los números dados</span>
            </li>
            <li className="flex items-start gap-2">
              <Check className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
              <span>Se encuentra listando <strong>divisores comunes</strong> y eligiendo el mayor</span>
            </li>
            <li className="flex items-start gap-2">
              <Check className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
              <span>Sirve para <strong>simplificar fracciones</strong> a su forma más simple</span>
            </li>
          </ul>
        </div>
