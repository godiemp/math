...
const QUESTIONS: Question[] = [
  {
    ...
    correctAnswer: 1,
    explanation: 'Usando (a + b)³ = a³ + 3a²b + 3ab² + b³ con a = x y b = 2: x³ + 3(x²)(2) + 3(x)(4) + 8 = x³ + 6x² + 12x + 8',
  },
  {
    id: 'q2',
    ...
    correctAnswer: 0,
    explanation: 'x³ - 64 = x³ - 4³ es una diferencia de cubos. Usando a³ - b³ = (a - b)(a² + ab + b²): (x - 4)(x² + 4x + 16). Recuerda SOAP: el término medio es positivo en diferencia de cubos.',
  },
  {
    id: 'q3',
    question: 'En (a - b)³ = a³ - 3a²b + 3ab² - b³, ¿qué patrón siguen los signos?',
    options: [
      'Todos positivos',
      'Todos negativos',
      'Alternan: +, -, +, -',
    ...
    correctAnswer: 2,
    explanation: 'En el cubo de una resta, los signos alternan: el primer término es +, el segundo -, el tercero +, y el cuarto -. Esto es porque cada vez que aparece un factor b, cambia el signo.',
  },
  {
    id: 'q4',
    ...
    correctAnswer: 1,
    explanation: 'x³ + 27 = x³ + 3³ es una suma de cubos porque 27 = 3³. Las otras opciones: 9 no es un cubo perfecto, x² + 8 tiene x², y x³ - 1 es una diferencia (no suma) de cubos.',
  },
];
    ...
    <div className="space-y-8 animate-fadeIn pb-32">
        ...
        <div className="space-y-6 animate-fadeIn">
          ...
          {passed && (
            <div className="bg-purple-50 dark:bg-purple-900/30 rounded-xl p-6 border border-purple-200 dark:border-purple-700">
              <h4 className="font-bold text-purple-800 dark:text-purple-200 mb-3">Recuerda los productos notables con cubos:</h4>
              ...
              <p className="mt-4 text-sm text-purple-700 dark:text-purple-300">
                Tip: Coeficientes 1-3-3-1 para cubo de binomio. SOAP para suma/diferencia de cubos.
              </p>
            </div>
          )}
      ...
      {showCelebration && (
        <Celebration
          ...
          message="Has dominado los productos notables con cubos: el cubo de un binomio y la suma/diferencia de cubos. ¡Ahora puedes expandir y factorizar expresiones cúbicas con confianza!"
