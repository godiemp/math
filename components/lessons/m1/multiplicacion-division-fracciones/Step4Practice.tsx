...
const PROBLEMS: Problem[] = [
  ...
  },
  {
    ...
    correctIndex: 2,
    hint: '6/12 se puede simplificar. ¿Por cuanto?',
  ...
  },
  {
    ...
    correctIndex: 2,
    hint: '6/15 se simplifica dividiendo por 3',
  ...
  },
  {
    ...
    options: ['20/40', '9/13', '1/2', '4/8'],
    correctIndex: 2,
    hint: 'Observa que 4 y 8 tienen factor comun, y 5 y 5 se cancelan',
    explanation: '4/5 × 5/8 = (4×5)/(5×8) = 20/40 = 1/2 (o simplifica: 4/8 × 5/5 = 1/2 × 1)',
  },
];
