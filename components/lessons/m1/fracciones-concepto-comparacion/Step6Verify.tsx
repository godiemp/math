...
const QUESTIONS: VerifyQuestion[] = [
  {
    ...
    options: ['1/4', '1/6'],
    correctAnswer: 0,
    explanation: 'Cuando el numerador es igual, el denominador menor significa partes más grandes. 1/4 > 1/6 porque dividir en 4 partes da porciones más grandes que dividir en 6.',
  },
  {
    id: 'q2',
    ...
    correctAnswer: 0,
    explanation: '2/4 y 1/2 son fracciones equivalentes. Ambas representan exactamente la mitad del entero.',
  },
  {
    id: 'q3',
    ...
    options: ['3/4', '5/8', '2/3'],
    correctAnswer: 0,
    explanation: '3/4 = 0.75, 5/8 = 0.625, 2/3 ≈ 0.67. Por lo tanto, 3/4 está más cerca de 1.',
  },
  {
    id: 'q4',
    question: 'Una fracción es:',
    type: 'multiple-choice',
    options: ['Dos números separados', 'Un solo número', 'Una operación de división'],
    correctAnswer: 1,
    explanation: 'Una fracción representa UN solo número que tiene una posición exacta en la recta numérica, aunque se escriba con dos números.',
  },
];
      ...
      <div className="space-y-6 animate-fadeIn">
        ...
        <div className={cn(
          ...
          <p className={cn(
            ...
            {percentage === 100 && '¡Perfecto! Dominaste las fracciones.'}
            {percentage >= 75 && percentage < 100 && '¡Muy bien! Tienes un sólido entendimiento.'}
            {percentage >= 50 && percentage < 75 && 'Buen progreso. Repasa los conceptos.'}
        ...
        <div className="bg-blue-50 dark:bg-blue-900/30 rounded-xl p-5 border border-blue-200 dark:border-blue-700">
          <h4 className="font-bold text-blue-800 dark:text-blue-200 mb-3">Resumen de la lección:</h4>
          <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">
            <li className="flex items-start gap-2">
              <Check className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
              Una fracción es <strong>un solo número</strong>
            </li>
            <li className="flex items-start gap-2">
              <Check className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
              Mayor denominador = partes más <strong>pequeñas</strong>
            </li>
            <li className="flex items-start gap-2">
              <Check className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
              <strong>1/2</strong> es un punto de referencia útil
            </li>
            <li className="flex items-start gap-2">
              <Check className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
              Fracciones diferentes pueden ser <strong>equivalentes</strong>
            </li>
          </ul>
        </div>
              ...
              <div className="flex items-center gap-3">
                <div className={cn(
                  ...
                  {showFeedback && (selectedAnswer === index || index === question.correctAnswer) ? (
                    index === question.correctAnswer ? <Check size={18} /> : <X size={18} />
                  ) : (
