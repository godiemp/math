...
const PROBLEMS: Problem[] = [
  {
    id: 'p1',
    question: 'Una tienda ofrece 15% de descuento en una mochila de $40.000. ¿Cuánto es el descuento?',
    hint: '15% de 40.000 = 15 × 40.000 ÷ 100. Primero multiplica 15 × 400.',
    options: ['$4.000', '$6.000', '$8.000', '$15.000'],
    correctAnswer: 1,
    explanation: '15% de $40.000 = 15 × 40.000 ÷ 100 = 600.000 ÷ 100 = $6.000',
  },
  {
    id: 'p2',
    question: 'En un curso hay 40 estudiantes. Si el 75% aprobó, ¿cuántos aprobaron?',
    hint: '75% es 3/4 del total. También puedes calcular: 75 × 40 ÷ 100.',
    options: ['20', '25', '30', '35'],
    correctAnswer: 2,
    explanation: '75% de 40 = 40 × 0,75 = 30 estudiantes aprobaron (75% = 3/4)',
  },
  {
    id: 'p3',
    question: '¿Qué porcentaje representa 15 de 60?',
    hint: 'Para encontrar el porcentaje: (parte ÷ total) × 100. Simplifica 15/60 primero.',
    options: ['15%', '20%', '25%', '30%'],
    correctAnswer: 2,
    explanation: '15 ÷ 60 × 100 = 0,25 × 100 = 25%. También: 15/60 = 1/4 = 25%',
  },
  {
    id: 'p4',
    question: 'Un producto costaba $80.000 y ahora cuesta $100.000. ¿Cuál fue el porcentaje de aumento?',
    hint: 'Aumento = 100.000 - 80.000 = $20.000. Luego: (aumento ÷ precio original) × 100.',
    options: ['20%', '25%', '30%', '80%'],
    correctAnswer: 1,
  ...
  {
    id: 'p5',
    question: 'Si ya usé el 40% de mi batería, ¿qué porcentaje me queda?',
    hint: 'El total siempre es 100%. Si gastaste 40%, ¿cuánto resta?',
    options: ['40%', '50%', '60%', '100%'],
    correctAnswer: 2,
    explanation: '100% - 40% = 60%. Si usaste el 40%, te queda el 60%.',
  },
];
        ...
        <>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
            ...
            <div className="flex justify-between items-center mb-4">
              <span className="px-3 py-1 rounded-full text-sm font-medium bg-green-100 dark:bg-green-900/50 text-green-700 dark:text-green-300">
                Porcentajes
              </span>
              {!showFeedback && (
                <button
        ...
        <div className="space-y-6 animate-fadeIn">
          ...
          >
            ...
            <p className={cn(correctCount >= 4 ? 'text-green-700 dark:text-green-300' : 'text-amber-700 dark:text-amber-300')}>
              {correctCount >= 4
                ? 'Dominas los problemas con porcentajes'
