        ...
        <div className="space-y-6 animate-fadeIn">
          ...
          <div className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/30 dark:to-orange-900/30 rounded-2xl p-6 border border-amber-200 dark:border-amber-800">
            <p className="text-gray-700 dark:text-gray-300 text-lg mb-6">
              ...
              Tiene <strong className="text-blue-600">5x manzanas</strong> y <strong className="text-green-600">15 naranjas</strong>.
            </p>
            ...
            <div className="flex flex-col items-center gap-6 mb-6">
              ...
              <div className="bg-amber-100 dark:bg-amber-900/50 rounded-xl p-4 max-w-md">
                <p className="text-amber-800 dark:text-amber-200 text-center">
                  Ana quiere usar <strong>la menor cantidad de cajas posible</strong>, pero cada caja debe tener
                  la <strong>misma cantidad total de productos</strong>.
                </p>
              </div>
            </div>
        ...
        <div className="space-y-6 animate-fadeIn">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/30 rounded-xl p-6 text-center border border-blue-200 dark:border-blue-700">
            <p className="text-lg font-semibold text-gray-800 dark:text-gray-200">
              Productos: <span className="font-mono text-blue-600">5x</span> manzanas + <span className="font-mono text-green-600">15</span> naranjas
            </p>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-inner">
                <div className="text-center space-y-4">
                  ...
                  <p className="font-mono text-sm text-gray-600 dark:text-gray-400">
                    = <span className="text-amber-600">5</span> · <span className="text-blue-600">x</span> + <span className="text-amber-600">5</span> · <span className="text-green-600">3</span>
                  </p>
                ...
                <div className="space-y-4 text-gray-700 dark:text-gray-300">
                  <div className="bg-white dark:bg-gray-800 p-4 rounded-xl text-center">
                    ...
                    <p className="font-mono text-lg">
                      <span className="text-amber-600 font-bold">a</span>x + <span className="text-amber-600 font-bold">a</span>y = <span className="text-amber-600 font-bold">a</span>(x + y)
                    </p>
                  </div>
