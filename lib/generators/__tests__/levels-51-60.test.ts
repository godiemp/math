...
describe('Levels 51-60: Algebraic Simplification', () => {
  ...
  it('Level 56: Simplificar ax+by+x', () => {
  ...
  it('Level 57: Simplificar ax+by-x', () => {
  ...
  it('Level 58: Simplificar ax+by+cx-dy', () => {
  ...
  it('Level 59: Simplificar a(x+b)+x', () => {
  ...
  it('Level 60: Simplificaciones Complejas', () => {
    ...
    for (let i = 0; i < 10; i++) {
      ...
      expect(problem.expression.length).toBeGreaterThan(5);
      expect(typeof problem.correctAnswer).toBe('string');
    }
  });
});
