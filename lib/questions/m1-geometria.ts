...
export const m1GeometriaQuestions: Question[] = [
  ...
  // BATCH 5: CIRCUNFERENCIA Y CÍRCULO (15 questions)
  ...
  // BATCH 6: TEOREMA DE PITÁGORAS Y APLICACIONES (15 questions)

  // Teorema de Pitágoras básico (3)
  {
    id: 'm1-207',
    level: 'M1',
    topic: 'Geometría',
