...
export const m2Num005Questions: Question[] = [
  {
    ...
    topic: 'Números',
    subject: 'números',
    question: 'Simplifica: $\\log_2 8 + \\log_2 4$',
  ...
  },
  {
    ...
    topic: 'Números',
    subject: 'números',
    question: 'Simplifica: $\\log_5 125 - \\log_5 25$',
  ...
  },
  {
    ...
    topic: 'Números',
    subject: 'números',
    question: 'Expresa como un solo logaritmo: $\\log x + \\log y - \\log z$',
  ...
  },
  {
    ...
    topic: 'Números',
    subject: 'números',
    question: 'Si $\\log_3 a = 2$ y $\\log_3 b = 4$, ¿cuál es $\\log_3(ab)$?',
  ...
  },
  {
    ...
    topic: 'Números',
    subject: 'números',
    question: 'Simplifica: $\\log_4 16^5$',
  ...
  },
  {
    ...
    topic: 'Números',
    subject: 'números',
    question: 'Expande: $\\log_2\\left(\\frac{x^3}{y^2}\\right)$',
