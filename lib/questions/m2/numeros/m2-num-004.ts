...
export const m2Num004Questions: Question[] = [
  {
    ...
    topic: 'Números',
    subject: 'números',
    question: '¿Cuál es el valor de $\\log_2 8$?',
  ...
  },
  {
    ...
    topic: 'Números',
    subject: 'números',
    question: 'Si $\\log_5 x = 3$, ¿cuál es el valor de $x$?',
  ...
  },
  {
    ...
    topic: 'Números',
    subject: 'números',
    question: '¿Cuál es el valor de $\\log_{10} 1000$?',
  ...
  },
  {
    ...
    topic: 'Números',
    subject: 'números',
    question: 'Si $2^x = 32$, ¿cuál es el valor de $x$ expresado como logaritmo?',
  ...
  },
  {
    ...
    topic: 'Números',
    subject: 'números',
    question: '¿Cuál es el valor de $\\log_3 \\frac{1}{9}$?',
  ...
  },
  {
    ...
    topic: 'Números',
    subject: 'números',
    question: 'Usando la fórmula de cambio de base, $\\log_4 16$ es igual a:',
  ...
  },
  {
    ...
    topic: 'Números',
    subject: 'números',
    question: '¿Cuál es el valor de $\\log_7 1$?',
  ...
  },
  {
    ...
    topic: 'Números',
    subject: 'números',
    question: 'Si $\\log_b 64 = 6$, ¿cuál es el valor de $b$?',
