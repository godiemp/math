...
export const m2Num006Questions: Question[] = [
  {
    ...
    topic: 'Números',
    subject: 'números',
    question: 'Resuelve la ecuación logarítmica: $\\log_2 x = 5$',
  ...
  },
  {
    ...
    topic: 'Números',
    subject: 'números',
    question: 'Resuelve la ecuación exponencial usando logaritmos: $2^x = 100$. Aproximadamente, ¿cuál es $x$?',
  ...
  },
  {
    ...
    topic: 'Números',
    subject: 'números',
    question: 'El pH de una sustancia se define como $pH = -\\log[H^+]$. Si $[H^+] = 10^{-4}$, ¿cuál es el pH?',
  ...
  },
  {
    ...
    topic: 'Números',
    subject: 'números',
    question: 'La escala de Richter para terremotos es $M = \\log\\left(\\frac{I}{I_0}\\right)$. Si un terremoto tiene magnitud 7, ¿cuántas veces más intenso es que uno de magnitud 5?',
  ...
  },
  {
    ...
    topic: 'Números',
    subject: 'números',
    question: 'El nivel de intensidad del sonido en decibeles es $dB = 10\\log\\left(\\frac{I}{I_0}\\right)$. Si un sonido es 80 dB, ¿cuántas veces más intenso es que el umbral $I_0$?',
