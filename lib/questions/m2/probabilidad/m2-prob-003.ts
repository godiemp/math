...
export const m2Prob003Questions: Question[] = [
  // Subsection A: Principio multiplicativo
  {
    ...
    questionLatex: '\\text{3 entradas, 4 platos de fondo, 2 postres. ¿Cuántos menús diferentes?}',
    options: ['9', '12', '24', '32'],
    correctAnswer: 2,
  ...
  },
  {
    ...
    questionLatex: '\\text{Contraseña: 2 letras (26 opciones c/u) + 3 dígitos (10 opciones c/u). ¿Total?}',
  ...
  // Subsection B: Permutaciones
  {
    ...
    questionLatex: '\\text{6 atletas, 3 medallas (orden importa). ¿Cuántas formas?}',
  ...
  // Subsection D: Problemas de conteo en probabilidad
  {
    ...
    questionLatex: '\\text{8 bolitas (5 rojas, 3 azules). Extraer 2 sin reposición. ¿Cuántos resultados?}',
    options: ['16', '24', '28', '64'],
    correctAnswer: 2,
  ...
  },
  {
    ...
    questionLatex: '\\text{Lanzar un dado 3 veces. ¿Cuántos resultados posibles (orden importa)?}',
    options: ['18', '20', '120', '216'],
    correctAnswer: 3,
