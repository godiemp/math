...
export const m2Prob002Questions: Question[] = [
  ...
  // ========================================
  // Subsección A: Concepto de probabilidad condicional
  {
    id: 'm2-prob-002-001',
    level: 'M2',
    topic: 'Probabilidad y Estadística',
    subject: 'probabilidad',
    operacionBase: 'P(B|A) = \\frac{P(A \\cap B)}{P(A)}',
    questionLatex: '\\text{Si } P(A) = 0.6 \\text{ y } P(A \\cap B) = 0.18\\text{, ¿cuál es } P(B|A)\\text{?}',
    options: ['0.10', '0.20', '0.30', '0.40'],
    correctAnswer: 2,
    explanation: 'P(B|A) = \\frac{P(A \\cap B)}{P(A)} = \\frac{0.18}{0.6} = 0.30',
    difficulty: 'easy',
    difficultyScore: 0.25,
    skills: ['probabilidad-condicional-concepto', 'probabilidad-condicional', 'numeros-decimales']
  },
  {
    id: 'm2-prob-002-002',
    level: 'M2',
    ...
    subject: 'probabilidad',
    operacionBase: 'P(A \\cap B) = P(A) \\times P(B|A)',
    questionLatex: '\\text{En una bolsa hay 10 canicas: 6 rojas y 4 azules. Se extraen 2 sin reposición. ¿Cuál es } P(\\text{ambas rojas})\\text{?}',
    options: ['\\frac{1}{3}', '\\frac{9}{25}', '\\frac{6}{15}', '\\frac{36}{100}'],
    correctAnswer: 0,
    explanation: 'P = \\frac{6}{10} \\times \\frac{5}{9} = \\frac{30}{90} = \\frac{1}{3}',
    difficulty: 'medium',
    difficultyScore: 0.38,
    skills: ['probabilidad-condicional-concepto', 'probabilidad-sin-reposicion', 'numeros-fracciones']
  },
  {
    id: 'm2-prob-002-003',
    level: 'M2',
    ...
    subject: 'probabilidad',
    operacionBase: 'P(A|B) \\neq P(B|A)',
    questionLatex: '\\text{¿Es cierto que } P(A|B) = P(B|A) \\text{ siempre?}',
    options: ['Sí, siempre son iguales', 'No, generalmente son diferentes', 'Solo si A y B son independientes', 'Solo si A y B son excluyentes'],
    correctAnswer: 1,
    explanation: 'P(A|B) = \\frac{P(A \\cap B)}{P(B)} \\neq P(B|A) = \\frac{P(A \\cap B)}{P(A)} \\text{ en general}',
    difficulty: 'easy',
    difficultyScore: 0.22,
    skills: ['probabilidad-condicional-concepto', 'probabilidad-conceptos']
  },
  {
    id: 'm2-prob-002-004',
    level: 'M2',
    topic: 'Probabilidad y Estadística',
    subject: 'probabilidad',
    operacionBase: 'P(A|B) = \\frac{n(A \\cap B)}{n(B)}',
    questionLatex: '\\text{De 50 estudiantes: 30 aprobaron matemáticas, 20 aprobaron física, 15 aprobaron ambas. Si un estudiante aprobó física, ¿cuál es la probabilidad de que aprobó matemáticas?}',
    options: ['\\frac{1}{2}', '\\frac{3}{4}', '\\frac{2}{3}', '\\frac{3}{10}'],
    correctAnswer: 1,
    explanation: 'P(M|F) = \\frac{15}{20} = \\frac{3}{4}',
    difficulty: 'easy',
    difficultyScore: 0.28,
    skills: ['probabilidad-condicional-concepto', 'probabilidad-condicional', 'numeros-fracciones']
  },
  // Subsección B: Teorema de Bayes
  {
    id: 'm2-prob-002-005',
    level: 'M2',
    topic: 'Probabilidad y Estadística',
    subject: 'probabilidad',
    operacionBase: 'P(A|B) = \\frac{P(B|A) \\cdot P(A)}{P(B)}',
    questionLatex: '\\text{La fórmula del Teorema de Bayes es:}',
    options: ['P(A|B) = P(A) \\cdot P(B)', 'P(A|B) = \\frac{P(B|A) \\cdot P(A)}{P(B)}', 'P(A|B) = P(A) + P(B)', 'P(A|B) = \\frac{P(A)}{P(B)}'],
    correctAnswer: 1,
    explanation: 'P(A|B) = \\frac{P(B|A) \\cdot P(A)}{P(B)} \\text{ (Teorema de Bayes)}',
    difficulty: 'easy',
    difficultyScore: 0.18,
    skills: ['probabilidad-bayes', 'probabilidad-formulas']
  },
  {
    id: 'm2-prob-002-006',
    level: 'M2',
    topic: 'Probabilidad y Estadística',
    subject: 'probabilidad',
    operacionBase: 'P(E|+) = \\frac{P(+|E) \\cdot P(E)}{P(+)}',
    questionLatex: '\\text{Una enfermedad afecta al 10\\% de la población. Un test tiene 95\\% de sensibilidad y 90\\% de especificidad. Si el test da positivo, ¿cuál es P(enfermo)?}',
    options: ['Aproximadamente 51%', 'Aproximadamente 68%', 'Aproximadamente 95%', 'Aproximadamente 90%'],
    correctAnswer: 0,
    explanation: 'P(E|+) = \\frac{0.95 \\times 0.10}{0.95 \\times 0.10 + 0.10 \\times 0.90} = \\frac{0.095}{0.185} \\approx 0.51',
    difficulty: 'hard',
    difficultyScore: 0.55,
    skills: ['probabilidad-bayes', 'probabilidad-teorema-bayes', 'numeros-decimales']
  },
  {
    id: 'm2-prob-002-007',
    level: 'M2',
    topic: 'Probabilidad y Estadística',
    subject: 'probabilidad',
    operacionBase: 'P(A_1|B) \\text{ vs } P(A_2|B)',
    questionLatex: '\\text{Dos urnas: Urna 1 (70\\% rojas), Urna 2 (30\\% rojas). Se elige urna con probabilidad 50\\%-50\\% y se saca bola roja. ¿De qué urna es más probable?}',
    options: ['Urna 1', 'Urna 2', 'Igual probabilidad', 'No se puede determinar'],
    correctAnswer: 0,
    explanation: 'P(U_1|R) = \\frac{0.70 \\times 0.50}{0.70 \\times 0.50 + 0.30 \\times 0.50} = \\frac{0.35}{0.50} = 0.70 > 0.30',
    difficulty: 'medium',
    difficultyScore: 0.42,
    skills: ['probabilidad-bayes', 'probabilidad-teorema-bayes', 'numeros-decimales']
  },
  // Subsección C: Eventos independientes y dependientes
  {
    id: 'm2-prob-002-008',
    level: 'M2',
    topic: 'Probabilidad y Estadística',
    subject: 'probabilidad',
    operacionBase: 'P(A \\cap B) = P(A) \\cdot P(B)',
    questionLatex: '\\text{Si } P(A) = 0.4, P(B) = 0.5 \\text{ y A, B son independientes, ¿cuál es } P(A \\cap B)\\text{?}',
    options: ['0.10', '0.20', '0.45', '0.90'],
    correctAnswer: 1,
    explanation: 'P(A \\cap B) = P(A) \\cdot P(B) = 0.4 \\times 0.5 = 0.20',
    difficulty: 'easy',
    difficultyScore: 0.22,
    skills: ['probabilidad-eventos-dependientes', 'probabilidad-eventos-independientes', 'numeros-decimales']
  },
  {
    id: 'm2-prob-002-009',
    level: 'M2',
    topic: 'Probabilidad y Estadística',
    subject: 'probabilidad',
    operacionBase: 'P(A|B) = P(A) \\Leftrightarrow \\text{independientes}',
    questionLatex: '\\text{¿Cuál es la condición para que A y B sean eventos independientes?}',
    options: ['P(A|B) = 0', 'P(A|B) = P(A)', 'P(A|B) = P(B)', 'P(A \\cap B) = 0'],
    correctAnswer: 1,
    explanation: '\\text{A y B independientes } \\Leftrightarrow P(A|B) = P(A)',
    difficulty: 'easy',
    difficultyScore: 0.22,
    skills: ['probabilidad-eventos-dependientes', 'probabilidad-conceptos']
  },
  {
    id: 'm2-prob-002-010',
    level: 'M2',
    topic: 'Probabilidad y Estadística',
    subject: 'probabilidad',
    operacionBase: 'P(B|A) \\neq P(B) \\Rightarrow \\text{dependientes}',
    questionLatex: '\\text{Si } P(B) = 0.3 \\text{ pero } P(B|A) = 0.5\\text{, ¿qué se puede concluir?}',
    options: ['A y B son independientes', 'A y B son dependientes', 'A y B son mutuamente excluyentes', 'No hay suficiente información'],
    correctAnswer: 1,
    explanation: 'P(B|A) = 0.5 \\neq P(B) = 0.3 \\Rightarrow \\text{A y B son dependientes}',
    difficulty: 'easy',
    difficultyScore: 0.28,
    skills: ['probabilidad-eventos-dependientes', 'probabilidad-condicional']
  },
  {
    id: 'm2-prob-002-011',
    level: 'M2',
    topic: 'Probabilidad y Estadística',
    subject: 'probabilidad',
    operacionBase: 'P(A \\cap B \\cap C) = P(A) \\cdot P(B) \\cdot P(C)',
    questionLatex: '\\text{Se lanzan 3 monedas independientes. ¿Cuál es la probabilidad de obtener 3 caras?}',
    options: ['\\frac{1}{8}', '\\frac{1}{4}', '\\frac{3}{8}', '\\frac{1}{2}'],
    correctAnswer: 0,
    explanation: 'P(CCC) = \\frac{1}{2} \\times \\frac{1}{2} \\times \\frac{1}{2} = \\frac{1}{8}',
    difficulty: 'easy',
    difficultyScore: 0.25,
    skills: ['probabilidad-eventos-dependientes', 'probabilidad-eventos-independientes', 'numeros-fracciones']
  },
  {
    id: 'm2-prob-002-012',
    level: 'M2',
    topic: 'Probabilidad y Estadística',
    subject: 'probabilidad',
    operacionBase: '\\text{Con vs sin reposición}',
    questionLatex: '\\text{¿En qué caso las extracciones de una urna son eventos independientes?}',
    options: ['Sin reposición', 'Con reposición', 'Nunca son independientes', 'Siempre son independientes'],
    correctAnswer: 1,
    explanation: '\\text{Con reposición: cada extracción tiene las mismas probabilidades (independientes)}',
    difficulty: 'easy',
    difficultyScore: 0.22,
    skills: ['probabilidad-eventos-dependientes', 'probabilidad-conceptos']
  },
  // Subsección D: Aplicaciones de probabilidad condicional
  {
    id: 'm2-prob-002-013',
    level: 'M2',
    topic: 'Probabilidad y Estadística',
    subject: 'probabilidad',
    operacionBase: 'P(A \\cap B) = P(A) \\cdot P(B|A)',
    questionLatex: '\\text{70\\% de los estudiantes estudian y de ellos 80\\% aprueba. ¿Cuál es la probabilidad de que un estudiante estudie y apruebe?}',
    options: ['0.50', '0.56', '0.70', '0.80'],
    correctAnswer: 1,
    explanation: 'P(E \\cap A) = P(E) \\cdot P(A|E) = 0.70 \\times 0.80 = 0.56',
    difficulty: 'easy',
    difficultyScore: 0.28,
    skills: ['probabilidad-condicional-aplicaciones', 'probabilidad-condicional', 'numeros-decimales']
  },
  {
    id: 'm2-prob-002-014',
    level: 'M2',
    topic: 'Probabilidad y Estadística',
    subject: 'probabilidad',
    operacionBase: 'P(G|P) = \\frac{P(P|G) \\cdot P(G)}{P(P)}',
    questionLatex: '\\text{60\\% de clientes son mujeres. El 40\\% de mujeres y 20\\% de hombres compran producto premium. Si alguien compra premium, ¿P(mujer)?}',
    options: ['\\frac{3}{4}', '\\frac{2}{3}', '\\frac{3}{5}', '\\frac{1}{2}'],
    correctAnswer: 0,
    explanation: 'P(M|P) = \\frac{0.40 \\times 0.60}{0.40 \\times 0.60 + 0.20 \\times 0.40} = \\frac{0.24}{0.32} = \\frac{3}{4}',
    difficulty: 'medium',
    difficultyScore: 0.45,
    skills: ['probabilidad-condicional-aplicaciones', 'probabilidad-bayes', 'numeros-fracciones']
  },
  {
    id: 'm2-prob-002-015',
    level: 'M2',
    topic: 'Probabilidad y Estadística',
    subject: 'probabilidad',
    operacionBase: 'P(D|E) \\cdot P(E)',
    questionLatex: '\\text{En un colegio, 55\\% son hombres. De los hombres, 30\\% practican fútbol. ¿Cuál es la probabilidad de elegir un hombre futbolista?}',
    options: ['0.165', '0.30', '0.55', '0.85'],
    correctAnswer: 0,
    explanation: 'P(H \\cap F) = P(H) \\cdot P(F|H) = 0.55 \\times 0.30 = 0.165',
    difficulty: 'easy',
    difficultyScore: 0.25,
    skills: ['probabilidad-condicional-aplicaciones', 'numeros-decimales']
  },
  {
    id: 'm2-prob-002-016',
    level: 'M2',
    topic: 'Probabilidad y Estadística',
    subject: 'probabilidad',
    operacionBase: 'P(A|B) \\text{ en contexto judicial}',
    questionLatex: '\\text{Una huella dactilar coincide con 1 de cada 1.000.000 personas. En una ciudad de 5 millones, ¿cuántas personas coincidirían además del culpable?}',
    options: ['0', '1', '5', '50'],
    correctAnswer: 2,
    explanation: '\\text{Coincidencias esperadas} = 5{,}000{,}000 \\times \\frac{1}{1{,}000{,}000} = 5 \\text{ (además del culpable)}',
    difficulty: 'medium',
    difficultyScore: 0.42,
    skills: ['probabilidad-condicional-aplicaciones', 'probabilidad-basica', 'numeros-operaciones-basicas']
  },
  {
    id: 'm2-prob-002-017',
    level: 'M2',
    topic: 'Probabilidad y Estadística',
    subject: 'probabilidad',
    operacionBase: 'P(\\text{al menos uno})',
    questionLatex: '\\text{Dos sistemas de seguridad funcionan independientemente con 95\\% de confiabilidad cada uno. ¿Cuál es la probabilidad de que al menos uno funcione?}',
    options: ['0.9025', '0.95', '0.9975', '0.90'],
    correctAnswer: 2,
    explanation: 'P(\\text{al menos 1}) = 1 - P(\\text{ambos fallen}) = 1 - 0.05^2 = 1 - 0.0025 = 0.9975',
    difficulty: 'medium',
    difficultyScore: 0.38,
    skills: ['probabilidad-condicional-aplicaciones', 'probabilidad-complemento', 'numeros-decimales']
  },
  {
    id: 'm2-prob-002-018',
    level: 'M2',
    topic: 'Probabilidad y Estadística',
    subject: 'probabilidad',
    operacionBase: 'P(A) \\cdot P(B|A) \\cdot P(C|A \\cap B)',
    questionLatex: '\\text{Una baraja tiene 52 cartas. Se sacan 3 cartas sin reposición. ¿Cuál es la probabilidad de que las 3 sean ases?}',
    options: ['\\frac{1}{5525}', '\\frac{4}{2197}', '\\frac{1}{13}', '\\frac{64}{140608}'],
    correctAnswer: 0,
    explanation: 'P = \\frac{4}{52} \\times \\frac{3}{51} \\times \\frac{2}{50} = \\frac{24}{132600} = \\frac{1}{5525}',
    difficulty: 'hard',
    difficultyScore: 0.55,
    skills: ['probabilidad-condicional-aplicaciones', 'probabilidad-sin-reposicion', 'numeros-fracciones']
  },
  {
    id: 'm2-prob-002-019',
    level: 'M2',
    topic: 'Probabilidad y Estadística',
    subject: 'probabilidad',
    operacionBase: 'P(\\text{lluvia } | \\text{pronóstico})',
    questionLatex: '\\text{Un pronóstico acierta el 80\\% de los días lluviosos y el 90\\% de los días secos. Si llueve el 30\\% de los días y el pronóstico dice "lluvia", ¿cuál es P(llueve)?}',
    options: ['\\frac{12}{19}', '\\frac{24}{31}', '\\frac{8}{10}', '\\frac{3}{10}'],
    correctAnswer: 1,
    explanation: 'P(L|P_L) = \\frac{0.80 \\times 0.30}{0.80 \\times 0.30 + 0.10 \\times 0.70} = \\frac{0.24}{0.31} = \\frac{24}{31}',
    difficulty: 'hard',
    difficultyScore: 0.52,
    skills: ['probabilidad-condicional-aplicaciones', 'probabilidad-bayes', 'numeros-fracciones']
  }
