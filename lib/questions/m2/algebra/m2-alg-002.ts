...
export const m2Alg002Questions: Question[] = [
  {
    ...
    subject: 'álgebra',
    question: '¿Cuál es el valor de $f(4)$ si $f(x) = x^3$?',
  ...
  },
  {
    ...
    topic: 'Álgebra y Funciones',
    subject: 'álgebra',
    question: 'Si $f(x) = x^{-2}$, ¿cuál es el valor de $f(2)$?',
  ...
  },
  {
    ...
    topic: 'Álgebra y Funciones',
    subject: 'álgebra',
    question: '¿Cuál es el dominio de la función $f(x) = x^{1/2}$?',
  ...
  },
  {
    ...
    topic: 'Álgebra y Funciones',
    subject: 'álgebra',
    question: 'Si $f(x) = x^{2/3}$, ¿cuál es el valor de $f(8)$?',
  ...
  },
  {
    ...
    topic: 'Álgebra y Funciones',
    subject: 'álgebra',
    question: '¿Cuál de las siguientes funciones tiene una gráfica que decrece en todo su dominio?',
  ...
  },
  {
    ...
    topic: 'Álgebra y Funciones',
    subject: 'álgebra',
    question: 'El recorrido de la función $f(x) = x^4$ para $x \\in \\mathbb{R}$ es:',
  ...
  },
  {
    ...
    topic: 'Álgebra y Funciones',
    subject: 'álgebra',
    question: 'Si $f(x) = x^{-3}$ y $f(a) = \\frac{1}{27}$, ¿cuál es el valor de $a$?',
