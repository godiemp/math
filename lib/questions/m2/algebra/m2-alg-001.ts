...
export const m2Alg001Questions: Question[] = [
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: '3x + 2y = 12 \\text{ y } 10x - 2y = 22 \\rightarrow 13x = 34 \\rightarrow x = 2, y = 3',
    difficulty: 'hard',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: '\\text{Sistema 3×3: eliminación gaussiana} \\rightarrow x = 2, y = 1, z = 1',
    difficulty: 'extreme',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: '3x + 4(2x - 1) = 20 \\rightarrow 3x + 8x - 4 = 20 \\rightarrow 11x = 24 \\rightarrow x = 2, y = 3',
    difficulty: 'medium',
