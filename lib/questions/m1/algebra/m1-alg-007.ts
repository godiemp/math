...
export const m1Alg007Questions: Question[] = [
  ...
  },
  {
    ...
    question: 'Un arqueólogo estudia la trayectoria de una flecha antigua disparada verticalmente. La altura de la flecha en metros se modela con f(x) = -x² + 4, donde x representa el tiempo en segundos. Como la parábola abre hacia abajo por el coeficiente negativo, existe un punto más alto que alcanza la flecha. El arqueólogo necesita determinar cuál es la altura máxima. ¿Cuál es el valor máximo de la función?',
    questionLatex: '\\text{Un arqueólogo estudia la trayectoria de una flecha antigua disparada verticalmente. La altura de la flecha en metros se modela con } f(x) = -x^2 + 4, \\text{ donde x representa el tiempo en segundos. Como la parábola abre hacia abajo por el coeficiente negativo, existe un punto más alto que alcanza la flecha. El arqueólogo necesita determinar cuál es la altura máxima. ¿Cuál es el valor máximo de la función?}',
