...
export const m1Geo001Questions: Question[] = [
  {
    ...
    correctAnswer: 0,
    explanation: 'La rampa forma la hipotenusa de un triángulo rectángulo donde los catetos son 3 m y 4 m. Aplicamos el teorema de Pitágoras:',
    explanationLatex: 'h^2 = 3^2 + 4^2 = 9 + 16 = 25 \\text{, entonces } h = \\sqrt{25} = 5 \\text{ m}',
    difficulty: 'easy',
  ...
  },
  {
    ...
    topic: 'Geometría',
    subject: 'geometría',
    question: 'Un cartógrafo está creando un mapa digital de la ciudad y necesita calcular distancias entre puntos de interés. En su sistema de coordenadas, el museo se encuentra en el punto A(1, 2) y el parque está en el punto B(4, 6), donde cada unidad representa un kilómetro. Para el sistema de navegación del mapa, debe calcular la distancia en línea recta entre estos dos lugares. Utilizando las coordenadas del plano, ¿cuál es la distancia entre el museo y el parque en kilómetros?',
    ...
    options: ['3', '4', '5', '7'],
    correctAnswer: 2,
    explanation: 'Calculamos la distancia usando las diferencias de coordenadas:',
    explanationLatex: 'd = \\sqrt{(4-1)^2 + (6-2)^2} = \\sqrt{3^2 + 4^2} = \\sqrt{9 + 16} = \\sqrt{25} = 5',
    difficulty: 'medium',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'La diagonal del cuadrado inscrito es igual al diámetro del círculo (10 cm). Usando la relación entre diagonal y lado en un cuadrado:',
    explanationLatex: 'l \\times \\sqrt{2} = 10 \\rightarrow l = \\frac{10}{\\sqrt{2}} = \\frac{10\\sqrt{2}}{2} = 5\\sqrt{2} \\approx 7.07 \\text{ cm}',
    difficulty: 'hard',
  ...
  },
  {
    ...
    topic: 'Geometría',
    subject: 'geometría',
    question: 'Un carpintero está fabricando marcos triangulares para reforzar la estructura de un techo. Cada marco tiene forma de triángulo rectángulo con dos piezas perpendiculares que miden 5 cm y 12 cm respectivamente. Para completar el marco, necesita cortar la pieza diagonal que conectará los extremos de estas dos piezas. ¿Cuál debe ser la longitud de la pieza diagonal en centímetros?',
    ...
    correctAnswer: 2,
    explanation: 'La pieza diagonal es la hipotenusa del triángulo rectángulo. Aplicamos el teorema de Pitágoras:',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'Verificamos si se cumple el teorema de Pitágoras con el lado más largo como hipotenusa:',
    explanationLatex: '7^2 + 24^2 = 49 + 576 = 625 = 25^2 \\quad \\checkmark \\text{ Sí es triángulo rectángulo}',
    difficulty: 'medium',
  ...
  },
  {
    ...
    topic: 'Geometría',
    subject: 'geometría',
    question: 'Una decoradora está instalando un espejo rectangular en la pared de un salón. El espejo mide 9 cm de alto y 12 cm de ancho. Para asegurarse de que el espejo quede perfectamente alineado, necesita medir la diagonal del espejo y verificarla con una cinta métrica. ¿Cuántos centímetros debe medir la diagonal del espejo?',
    ...
    correctAnswer: 1,
    explanation: 'La diagonal del rectángulo forma la hipotenusa de un triángulo rectángulo con lados 9 y 12:',
    explanationLatex: 'd^2 = 9^2 + 12^2 = 81 + 144 = 225 \\rightarrow d = \\sqrt{225} = 15 \\text{ cm}',
    difficulty: 'easy',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'En un cuadrado, la diagonal es igual al lado multiplicado por raíz de 2. Despejamos el lado:',
    explanationLatex: 'l \\times \\sqrt{2} = 10 \\rightarrow l = \\frac{10}{\\sqrt{2}} = \\frac{10\\sqrt{2}}{2} = 5\\sqrt{2} \\approx 7.07 \\text{ cm}',
    difficulty: 'medium',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation: 'La escalera, la pared y el suelo forman un triángulo rectángulo. La altura es un cateto:',
    explanationLatex: 'h^2 = 5^2 - 3^2 = 25 - 9 = 16 \\rightarrow h = \\sqrt{16} = 4 \\text{ m}',
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['3', '4', '5', '7'],
    correctAnswer: 2,
    explanation: 'Usamos la fórmula de distancia entre dos puntos en el plano:',
    explanationLatex: 'd = \\sqrt{(6-2)^2 + (6-3)^2} = \\sqrt{4^2 + 3^2} = \\sqrt{16 + 9} = \\sqrt{25} = 5',
    difficulty: 'medium',
    skills: ['geometria-plano-cartesiano', 'geometria-distancia', 'geometria-pitagoras', 'numeros-raices', 'numeros-potencias', 'numeros-operaciones-basicas'],
    operacionBase: 'd = \\sqrt{(x_2-x_1)^2 + (y_2-y_1)^2}'
  },
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'Verificamos cada conjunto. Para (5, 12, 13):',
    explanationLatex: '5^2 + 12^2 = 25 + 144 = 169 = 13^2 \\quad \\checkmark \\text{ Es terna pitagórica}',
    difficulty: 'easy',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'Multiplicando (3, 4, 5) por 2 obtenemos (6, 8, 10):',
    explanationLatex: '(6, 8, 10) = 2(3, 4, 5) \\text{ y cumple: } 6^2 + 8^2 = 36 + 64 = 100 = 10^2',
    difficulty: 'medium',
  ...
  },
  {
    ...
    topic: 'Geometría',
    subject: 'geometría',
    question: 'Un barco de pesca sale del puerto y navega en línea recta hacia el norte durante 12 kilómetros. Luego cambia de dirección y navega hacia el este en línea recta durante 16 kilómetros adicionales. El capitán quiere saber cuál es la distancia más corta desde su posición actual hasta el puerto de origen, para calcular el combustible necesario para el regreso directo. ¿A qué distancia en kilómetros se encuentra el barco del puerto?',
    ...
    correctAnswer: 1,
    explanation: 'Los dos desplazamientos perpendiculares forman un triángulo rectángulo con el puerto:',
    explanationLatex: 'd^2 = 12^2 + 16^2 = 144 + 256 = 400 \\rightarrow d = \\sqrt{400} = 20 \\text{ km}',
    difficulty: 'medium',
    skills: ['geometria-pitagoras', 'geometria-aplicaciones', 'numeros-raices', 'numeros-potencias', 'numeros-operaciones-basicas'],
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation: 'En un triángulo equilátero, la altura divide al triángulo en dos triángulos rectángulos. La base de cada uno es 3 cm (mitad de 6) y la hipotenusa es 6 cm:',
    explanationLatex: 'h^2 = 6^2 - 3^2 = 36 - 9 = 27 \\rightarrow h = \\sqrt{27} = 3\\sqrt{3} \\approx 5.20 \\text{ cm}',
    difficulty: 'hard',
