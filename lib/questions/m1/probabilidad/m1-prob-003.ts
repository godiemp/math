...
export const m1Prob003Questions: Question[] = [
  // A. Cálculo de cuartiles
  {
    ...
    question: 'Un profesor de educación física registra los tiempos de carrera de 7 estudiantes en orden creciente: 2, 4, 6, 8, 10, 12, 14 minutos. Para analizar el rendimiento del grupo, necesita calcular el segundo cuartil (Q2). ¿Cuál es el valor del segundo cuartil?',
  ...
  },
  {
    ...
    question: 'Una investigadora de mercado analiza las edades de 9 participantes en una encuesta. Los datos ordenados son: 3, 5, 7, 9, 11, 13, 15, 17, 19 años. Necesita calcular el primer cuartil (Q1) para identificar el rango de edades del 25% más joven. ¿Cuál es el primer cuartil?',
  ...
  },
  {
    ...
    question: 'Un gerente de ventas revisa las cifras de ventas mensuales de su equipo en miles de pesos: 10, 20, 30, 40, 50, 60, 70, 80, 90. Necesita calcular el tercer cuartil (Q3) para determinar el nivel de ventas que supera al 75% de los meses. ¿Cuál es el tercer cuartil?',
  ...
  },
  {
    ...
    question: 'Un nutricionista registra el consumo diario de agua en litros de 6 pacientes: 5, 10, 15, 20, 25, 30. Necesita calcular el primer cuartil (Q1) para identificar el consumo típico del 25% de pacientes con menor ingesta. ¿Cuál es el valor del primer cuartil?',
  ...
  },
  {
    ...
    question: 'Un analista financiero estudia los precios de acciones durante 8 días consecutivos en miles de pesos: 12, 18, 20, 24, 30, 32, 40, 45. Necesita calcular el rango intercuartílico (IQR) para medir la dispersión del 50% central de los datos. ¿Cuál es el rango intercuartílico?',
  ...
  },
  {
    ...
    question: 'Una maestra evalúa las calificaciones de 5 estudiantes que están ordenadas así: 2, 4, 6, 8, 10. Ella identifica que la mediana del conjunto completo es 6. Ahora necesita calcular el primer cuartil (Q1). ¿Cuál es el primer cuartil?',
  ...
  },
  {
    ...
    question: 'En una prueba estandarizada nacional, un estudiante recibe su resultado junto con la información de que está en el percentil 75 (P75). Su familia le pregunta qué significa exactamente este valor. ¿Qué significa estar en el percentil 75?',
  ...
  },
  {
    ...
    question: 'Una economista analiza la distribución de salarios en una empresa grande y encuentra que el percentil 10 (P10) de los salarios es $400,000 pesos mensuales. El sindicato de trabajadores solicita una explicación clara de qué significa este valor estadístico. ¿Qué significa que el percentil 10 sea $400,000?',
  ...
  // C. Construcción de diagramas de caja
  {
    ...
    question: 'Una estudiante de estadística aprende a construir diagramas de caja (box plots) en su clase. El profesor explica que este gráfico se basa en un "resumen de cinco números" que captura las características clave de la distribución de datos. ¿Cuáles son los cinco valores que se utilizan?',
  ...
  },
  {
    ...
    question: 'Durante una presentación de análisis de datos, un investigador muestra un diagrama de caja a su audiencia. Un asistente observa una línea vertical dibujada dentro de la caja rectangular y pregunta qué representa exactamente esa línea. ¿Qué representa la línea dentro de la caja?',
  ...
  },
  {
    ...
    question: 'Un bioestadístico analiza 7 mediciones de temperatura corporal en grados Celsius: 5, 10, 15, 20, 25, 30, 35. Necesita determinar el resumen de cinco números para crear un diagrama de caja completo. ¿Cuál es el resumen de cinco números correcto?',
  ...
  },
  {
    ...
    question: 'Un instructor de estadística muestra a sus estudiantes un diagrama de caja completo y señala las líneas que se extienden desde los bordes de la caja rectangular hacia los valores extremos. Explica que estas líneas se llaman "bigotes" (whiskers en inglés). ¿Desde dónde se extienden los bigotes?',
  ...
  // D. Interpretación de diagramas de caja
  {
    ...
    question: 'Una analista examina el diagrama de caja de los tiempos de respuesta de un servidor web y nota que la línea de la mediana (Q2) dentro de la caja está ubicada mucho más cerca del borde inferior (Q1) que del borde superior (Q3). ¿Qué indica esta configuración?',
  ...
  },
  {
    ...
    question: 'Un investigador educativo compara el rendimiento en matemáticas de dos grupos de estudiantes mediante diagramas de caja. El Grupo A muestra un rango intercuartílico (IQR) de 10 puntos, mientras que el Grupo B tiene un IQR de 30 puntos. ¿Qué indica esta diferencia?',
  ...
  },
  {
    ...
    question: 'Un epidemiólogo analiza un diagrama de caja de los tiempos de recuperación de pacientes en días y observa estos valores: Mínimo=10, Q1=20, Q2=25, Q3=30, Máximo=80. El valor máximo parece estar inusualmente alejado del resto de los datos. ¿Qué se puede concluir sobre este conjunto de datos?',
  ...
  },
  {
    ...
    question: 'Un matemático presenta a sus estudiantes un diagrama de caja perfectamente simétrico y les pide que identifiquen la relación matemática entre los tres cuartiles. ¿Qué relación existe en un diagrama simétrico?',
