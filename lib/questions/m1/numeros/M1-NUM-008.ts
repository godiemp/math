...
export const m1Num008Questions: Question[] = [
  ...
  },
  {
    ...
    question: 'Un ingeniero divide dos mediciones: 8 × 10⁶ entre 2 × 10². Para dividir números en notación científica, divide los coeficientes y resta los exponentes. ¿Cuál es el resultado?',
    questionLatex: '\\text{Un ingeniero divide dos mediciones: } 8 \\times 10^6 \\text{ entre } 2 \\times 10^2\\text{. Para dividir números en notación científica, divide los coeficientes y resta los exponentes. ¿Cuál es el resultado?}',
  ...
  },
  {
    ...
    question: 'Un astrónomo suma dos distancias: 3 × 10⁵ km y 7 × 10⁵ km. Cuando los exponentes son iguales, se pueden sumar los coeficientes directamente. ¿Cuál es la suma total?',
    questionLatex: '\\text{Un astrónomo suma dos distancias: } 3 \\times 10^5 \\text{ km y } 7 \\times 10^5 \\text{ km. Cuando los exponentes son iguales, se pueden sumar los coeficientes directamente. ¿Cuál es la suma total?}',
