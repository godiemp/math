...
export const m1Num004Questions: Question[] = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation: 'Para convertir una fracción a decimal, dividimos el numerador entre el denominador: 3 ÷ 4 = 0,75.',
    explanationLatex: '\\frac{3}{4} = 3 \\div 4 = 0{,}75',
    difficulty: 'easy',
  ...
  },
  {
    ...
    options: ['60%', '70%', '75%', '80%'],
    correctAnswer: 2,
    explanation: 'Para convertir una fracción a porcentaje, dividimos el numerador entre el denominador y multiplicamos por 100: (3 ÷ 4) × 100 = 0,75 × 100 = 75%.',
    explanationLatex: '\\frac{3}{4} = 0{,}75 = 75\\%',
    difficulty: 'easy',
  ...
  },
  {
    ...
    optionsLatex: ['\\frac{1}{2}', '\\frac{3}{5}', '\\frac{2}{3}', '\\frac{6}{10}'],
    correctAnswer: 1,
    explanation: 'El decimal 0,6 significa 6 décimos: 6/10. Para simplificar, dividimos numerador y denominador por su máximo común divisor (2): 6/10 = 3/5.',
    explanationLatex: '0{,}6 = \\frac{6}{10} = \\frac{3}{5}',
    difficulty: 'easy',
  ...
  },
  {
    ...
    optionsLatex: ['\\frac{9}{20}', '\\frac{45}{100}', '\\frac{5}{11}', '\\frac{4}{9}'],
    correctAnswer: 0,
    explanation: 'El porcentaje 45% significa 45 de cada 100: 45/100. Simplificamos dividiendo numerador y denominador por su máximo común divisor (5): 45/100 = 9/20.',
    explanationLatex: '45\\% = \\frac{45}{100} = \\frac{9}{20}',
    difficulty: 'medium',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation: 'Para convertir un decimal a porcentaje, multiplicamos por 100: 0,35 × 100 = 35%.',
    explanationLatex: '0{,}35 \\times 100 = 35\\%',
    difficulty: 'easy',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'Para convertir un porcentaje a decimal, dividimos por 100: 120 ÷ 100 = 1,2.',
    explanationLatex: '120\\% = \\frac{120}{100} = 1{,}2',
    difficulty: 'medium',
  ...
  },
  {
    ...
    options: ['25%', '30%', '40%', '50%'],
    correctAnswer: 2,
    explanation: 'Convertimos la fracción a decimal: 2 ÷ 5 = 0,4. Luego convertimos a porcentaje: 0,4 × 100 = 40%.',
    explanationLatex: '\\frac{2}{5} = 0{,}4 = 40\\%',
    difficulty: 'easy',
  ...
  },
  {
    ...
    optionsLatex: ['\\frac{1}{8}', '\\frac{1}{10}', '\\frac{1}{12}', '\\frac{1}{16}'],
    correctAnswer: 0,
    explanation: 'El decimal 0,125 tiene tres decimales, así que representa 125/1000. Simplificamos dividiendo numerador y denominador por 125: 125/1000 = 1/8.',
    explanationLatex: '0{,}125 = \\frac{125}{1000} = \\frac{1}{8}',
    difficulty: 'hard',
    skills: ['numeros-decimales', 'numeros-fracciones', 'numeros-conversiones', 'numeros-simplificacion', 'numeros-operaciones-basicas']
  },
  {
    ...
    optionsLatex: ['\\frac{1}{12}', '\\frac{2}{25}', '\\frac{4}{50}', '\\frac{8}{100}'],
    correctAnswer: 1,
    explanation: 'El porcentaje 8% significa 8 de cada 100: 8/100. Simplificamos dividiendo numerador y denominador por su máximo común divisor (4): 8/100 = 2/25.',
    explanationLatex: '8\\% = \\frac{8}{100} = \\frac{2}{25}',
    difficulty: 'medium',
    skills: ['numeros-porcentajes', 'numeros-fracciones', 'numeros-conversiones', 'numeros-simplificacion', 'numeros-operaciones-basicas']
  }
];
