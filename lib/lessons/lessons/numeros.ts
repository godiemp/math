...
export const NUMEROS_LESSONS: Lesson[] = [
  ...
  {
    id: 'm1-num-003-a',
    slug: 'problemas-vida-cotidiana',
    title: 'Problemas de la Vida Cotidiana',
    description: 'Aprende a resolver problemas con números enteros y racionales en contextos de dinero, temperatura, recetas y distancia.',
    level: 'M1',
    subject: 'números',
    thematicUnit: 'M1-NUM-003',
    skills: ['numeros-problemas-vida-cotidiana'],
    estimatedMinutes: 15,
    minEducOA: ['MA1M-OA-01'],
    steps: [
      { id: 'hook', type: 'hook', title: 'La Cuenta del Supermercado' },
      { id: 'explore', type: 'explore', title: 'Tipos de Problemas' },
      { id: 'explain', type: 'explain', title: 'Estrategias de Resolución' },
      { id: 'classify', type: 'explore', title: 'Clasifica la Operación' },
