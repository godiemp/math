...
export const ALGEBRA_LESSONS: Lesson[] = [
  ...
  },
  {
    ...
    description: 'Aprende a traducir expresiones verbales al lenguaje algebraico usando variables y operaciones.',
    level: 'M1',
    subject: 'álgebra',
    thematicUnit: 'M1-ALG-002',
    skills: ['algebra-lenguaje-algebraico', 'algebra-traduccion', 'algebra-expresiones'],
    estimatedMinutes: 14,
    minEducOA: ['MA07-OA-06'],
    steps: [
      { id: 'hook', type: 'hook', title: 'El Mensaje Secreto' },
      { id: 'explore', type: 'explore', title: 'El Diccionario Algebraico' },
      { id: 'explain', type: 'explain', title: 'Las Reglas de Traducción' },
      { id: 'classify', type: 'explore', title: 'El Traductor' },
      { id: 'practice', type: 'practice', title: 'Practica la Traducción' },
      { id: 'verify', type: 'verify', title: 'Checkpoint' },
    ],
  },
  {
  ...
  {
    id: 'm1-alg-011-b',
    slug: 'formula-cuadratica',
    title: 'Fórmula Cuadrática',
    description: 'Aprende a resolver cualquier ecuación cuadrática usando la fórmula x = (-b ± √(b²-4ac)) / 2a.',
    level: 'M1',
    subject: 'álgebra',
    thematicUnit: 'M1-ALG-011',
    ...
    steps: [
      ...
      { id: 'explain', type: 'explain', title: 'La Fórmula Cuadrática' },
      { id: 'classify', type: 'explore', title: 'Identifica y Calcula' },
      { id: 'practice', type: 'practice', title: 'Resuelve con la Fórmula' },
      { id: 'verify', type: 'verify', title: 'Checkpoint' },
    ],
  },
  {
