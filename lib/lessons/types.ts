...
export const M1_LESSONS: Lesson[] = [
  ...
  },
  {
    ...
    estimatedMinutes: 15,
    steps: [
      { id: 'hook', type: 'hook', title: 'El Gerente de la Empresa', requiredToAdvance: true },
      { id: 'explore', type: 'explore', title: 'Descubre el Patrón', requiredToAdvance: true },
      { id: 'explain', type: 'explain', title: 'Las Reglas de la Operatoria' },
      { id: 'classify', type: 'explore', title: 'Identifica el Resultado', requiredToAdvance: true },
      { id: 'practice', type: 'practice', title: 'Práctica Guiada', requiredToAdvance: true },
      { id: 'verify', type: 'verify', title: 'Checkpoint', requiredToAdvance: true },
    ],
  },
  {
    ...
    estimatedMinutes: 15,
    steps: [
      { id: 'hook', type: 'hook', title: 'El Misterio del Precio', requiredToAdvance: true },
      { id: 'explore', type: 'explore', title: 'Descubre el Patrón', requiredToAdvance: true },
      { id: 'explain', type: 'explain', title: 'Método para Resolver Problemas' },
      { id: 'classify', type: 'explore', title: 'Identifica la Ecuación', requiredToAdvance: true },
      { id: 'practice', type: 'practice', title: 'Práctica Guiada', requiredToAdvance: true },
      { id: 'verify', type: 'verify', title: 'Checkpoint', requiredToAdvance: true },
    ],
  },
  {
    ...
    estimatedMinutes: 15,
    steps: [
      { id: 'hook', type: 'hook', title: 'El Viaje en Auto', requiredToAdvance: true },
      { id: 'explore', type: 'explore', title: 'Descubre el Patrón', requiredToAdvance: true },
      { id: 'explain', type: 'explain', title: 'Proporciones: Directa e Inversa' },
      { id: 'classify', type: 'explore', title: 'Clasifica la Proporción', requiredToAdvance: true },
      { id: 'practice', type: 'practice', title: 'Práctica Guiada', requiredToAdvance: true },
      { id: 'verify', type: 'verify', title: 'Checkpoint', requiredToAdvance: true },
    ],
  },
